...
// add ADE (arXiv:1905.12618) by Gen Ye
enum equation_of_state {CLP,EDE,ADE};
...
struct background
{
  ...
  /* ndescf parameters, by Gen Ye */
  int N_ndescf;                                   /**< Number of non dark energy scalar fields */
  int ndescf_parameters_size;                     /**< size of ndescf_parameters for each of the field, should be the same */
  double * Omega0_ndescf;                         /**< Omega0_ndescf for each non dark energy scalar field */
  double * m_ndescf_in_eV;                        /**< mass of ndescf (axion) in unit of eV */
  double Omega0_ndescf_tot, Omega0_ndescf_tot_real; /**< total Omega0 for all ndescfs, shooting parameter, _real for actual value after background solve */
  double * ndescf_parameters;                     /**< list of parameters describing all non dark energy scalar fields */
  double * ndescf_w_fld;                          /**< list of effective EoS params used in fluid approximation */
  double * ndescf_m_fld;                          /**< list of energy scale at which fluid approximation is turned on */
  double * ndescf_loga_fld;                       /**< list of log scale factor at which fluid approximation is turned on */
  double * ndescf_tau_fld;                        /**< list of conformal time at which fluid approximation is turned on */
  double * ndescf_tau_avgfld;                     /**< list of conformal time at which we start averaing over oscillation */
  double ndescf_fld_threshold;                    /**< m/H above which fluid approximation used */
  int * ndescf_sorted_index;                      /**< indices that sort ndescf_loga_fld */
  short * ndescf_use_kg;                          /**< solve full Klein-Gorden eq. for ndescf? */
  short adaptive_step_bk_sampling;                /**< use adaptive step size when sampling background table? */
  ...
  /* Acoustic dark energy from arXiv:1905.12618 */
  double a_ADE;            /**< scale factor a/a_0 at dark fluid EoS transition */
  double f_ADE;            /**< energy fraction of dark fluid at a_PDF */
  double wf_ADE;           /**< EoS param for PDF after a/a_0 */
  double cs2_ADE;          /**< ADE rest frame sound speed squared */
  double cvis2_ADE;        /**< ADE effective viscosity param */
  /* end of modification by Gen Ye */
  ...
  // add non dark energy scalar field indices pointing to the first ndescf, by Gen Ye
  int index_bg_phi_ndescf1;       /**< ndescf value */
  int index_bg_phi_prime_ndescf1; /**< ndescf field derivative wrt conformal time */
  int index_bg_V_ndescf1;         /**< ndescf field potential V */
  int index_bg_dV_ndescf1;        /**< ndescf field potential derivative V' */
  int index_bg_ddV_ndescf1;       /**< ndescf field potential second derivative V'' */
  int index_bg_rho_ndescf1;       /**< ndescf field energy density */
  int index_bg_p_ndescf1;         /**< ndescf field pressure */
  int index_bg_p_prime_ndescf1;         /**< ndescf field pressure conformal derivative */
  ...
  /* add ndescf integration variables, both KG and fld, by Gen Ye */
  int index_bi_phi_ndescf1;         /**< {B} scalar field value for the first non dark energy scalar field */
  int index_bi_phi_prime_ndescf1;   /**< {B} scalar field conformal derivative value for the first non dark energy scalar field */
  int index_bi_rho_ndescf1;         /**< {B} scalar field energy density value for the first non dark energy scalar field */

  int index_bi_loga;                /**< {B} log scale factor, needed in step by step integration in ndescf case
  /* end of modification by Gen Ye */
  ...
  short force_ede;     /**< force scf evolution disregarding of Omega0_scf? by Gen Ye */
  ...
  short has_ndescf;    /**< presence of non dark energy scalar fields? by Gen Ye */
...
extern "C" {
  ...
  int background_indices(
                         struct precision *ppr, // added by Gen Ye
                         struct background *pba
                         );
  ...
  /** Non dark energy potential and its derivatives, by Gen Ye **/
  double V_ndescf(
    struct background * pba,
    double phi,
    int n_ndescf);
