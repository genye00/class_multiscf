...
enum fa_ndescf_flags {fa_ndescf_off, fa_ndescf_on}; // flags for non dark energy scalar field fluid approximation by Gen Ye
...
struct perturbations
{
  ...
  double A_eisw;  /**< rescale the late eisw */
  double A_lisw;  /**< rescale the late lisw */
  ...
  short has_source_delta_ndescf; /**< do we need source for delta of additional scalar fields? by Gen Ye */
  ...
  short has_source_bigtheta_ndescf; /**< do we need source for big theta of additional scalar fields? by Gen Ye*/
  ...
  /* add Klein-Gordon scf eq flag by Gen Ye*/
  short use_kg_scf; /**< do we evolve scf using KG eq? */
  ...
  int index_tp_delta_ndescf1; /**< index value for delta of first non dark energy scf by Gen Ye */
  ...
  int index_tp_bigtheta_ndescf1; /**< index value for big theta of first non dark energy scf by Gen Ye */
...
struct perturbations_vector
{
  ...
  /* non dark energy scalar fields variables, by Gen Ye */
  int index_pt_x1_ndescf1;          /**< first non dark energy scalar field perturbation1, x1=phi in KG, x1=delta in fld */
  int index_pt_x2_ndescf1;          /**< first non dark energy scalar field perturbation2, x2=phi_prime in KG, x2=theta in fld */
  /* end of modification by Gen Ye */
  ...
  int index_pt_phi_scf;  /**< scalar field perturbation */
  int index_pt_phi_prime_scf;  /**< conformal derivative of scalar field perturbation */
...
struct perturbations_workspace
{
  ...
  */
  ...
  /* ndescf by Gen Ye */
//  double * ndescf_delta_max;     /**< delta oscillation maxima */
//  double * ndescf_delta_min;     /**< delta oscillation maxima */
  double * ndescf_bigtheta_max;  /**< bigtheta oscillation maxima */
  double * ndescf_bigtheta_min;  /**< bigtheta oscillation minima */
  ...
  int index_ap_fa_ndescf1; /**< index for the first non dark energy scalar field fluid approximation by Gen Ye */
