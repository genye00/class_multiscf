...
enum target_names {theta_s, Omega_dcdmdr, omega_dcdmdr, Omega_ndescf_stQ, Omega_scf, Omega_ini_dcdm, omega_ini_dcdm, sigma8}; // add ndescf target, by Gen Ye
/* Important: Keep this number equal to the number of target_names */
#define _NUM_TARGETS_ 8 // add ndescf target, by Gen Ye
