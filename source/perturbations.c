...
)
{
    ...
    int n_ncdm;
    int n_ndescf; // ndescf index by Gen Ye
    ...
    {
        class_alloc(tkfull,
                    ppt->k_size[index_md]*ppt->ic_size[index_md]*ppt->tp_size[index_md]*sizeof(
                        double),
                    ppt->error_message);
    }
    ...
    if(z == 0.)
    {
        ...
        for(index_k = 0; index_k < ppt->k_size[index_md]; index_k++)
        {
            for(index_tp = 0; index_tp < ppt->tp_size[index_md]; index_tp++)
            {
                ...
                {
                    tkfull[(index_k * ppt->ic_size[index_md] + index_ic) * ppt->tp_size[index_md] +
                                                                         index_tp]
                        = ppt->sources[index_md][index_ic * ppt->tp_size[index_md] +
                                                 index_tp][(ppt->tau_size - 1) *
    ...
    for(index_ic = 0; index_ic < ppt->ic_size[index_md]; index_ic++)
    {
        ...
        for(index_k = 0; index_k < ppt->k_size[index_md]; index_k++)
        {
            ...
            storeidx = 0;
            dataptr = data + index_ic * (ppt->k_size[index_md] * number_of_titles) + index_k
                      * number_of_titles;
            tk = &(tkfull[(index_k * ppt->ic_size[index_md] + index_ic) *
            ...
            if(output_format == class_format)
            {
                ...
                {
                    class_store_double(dataptr, tk[ppt->index_tp_delta_g], ppt->has_source_delta_g,
                                       storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_delta_b], ppt->has_source_delta_b,
                                       storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_delta_cdm],
                                       ppt->has_source_delta_cdm, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_delta_idm_dr],
                                       ppt->has_source_delta_idm_dr, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_delta_fld],
                                       ppt->has_source_delta_fld, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_delta_ur],
                                       ppt->has_source_delta_ur, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_delta_idr],
                                       ppt->has_source_delta_idr, storeidx);
                    if(pba->has_ncdm == _TRUE_)
                    {
                        for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
                        {
                            class_store_double(dataptr, tk[ppt->index_tp_delta_ncdm1 + n_ncdm],
                                               ppt->has_source_delta_ncdm,
                                               storeidx);
                        }
                    }
                    class_store_double(dataptr, tk[ppt->index_tp_delta_dcdm],
                                       ppt->has_source_delta_dcdm, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_delta_dr],
                                       ppt->has_source_delta_dr, storeidx);
                    if(pba->has_ndescf == _TRUE_)
                    {
                        for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
                        {
                            class_store_double(dataptr, tk[ppt->index_tp_delta_ndescf1 + n_ndescf],
                                               ppt->has_source_delta_ndescf,
                                               storeidx);
                        }
                    }
                    class_store_double(dataptr, tk[ppt->index_tp_delta_scf],
                                       ppt->has_source_delta_scf, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_delta_tot],
                                       ppt->has_source_delta_tot, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_phi], ppt->has_source_phi,
                                       storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_psi], ppt->has_source_psi,
                                       storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_phi_prime],
                                       ppt->has_source_phi_prime, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_h], ppt->has_source_h, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_h_prime], ppt->has_source_h_prime,
                                       storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_eta], ppt->has_source_eta,
                                       storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_eta_prime],
                                       ppt->has_source_eta_prime, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_H_T_Nb_prime],
                                       ppt->has_source_H_T_Nb_prime, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_k2gamma_Nb],
                                       ppt->has_source_k2gamma_Nb, storeidx);
                }
                if(ppt->has_velocity_transfers == _TRUE_)
                {

                    class_store_double(dataptr, tk[ppt->index_tp_theta_g], ppt->has_source_theta_g,
                                       storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_theta_b], ppt->has_source_theta_b,
                                       storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_theta_cdm],
                                       ppt->has_source_theta_cdm, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_theta_idm_dr],
                                       ppt->has_source_theta_idm_dr, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_theta_fld],
                                       ppt->has_source_theta_fld, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_theta_ur],
                                       ppt->has_source_theta_ur, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_theta_idr],
                                       ppt->has_source_theta_idr, storeidx);
                    if(pba->has_ncdm == _TRUE_)
                    {
                        for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
                        {
                            class_store_double(dataptr, tk[ppt->index_tp_theta_ncdm1 + n_ncdm],
                                               ppt->has_source_theta_ncdm,
                                               storeidx);
                        }
                    }
                    class_store_double(dataptr, tk[ppt->index_tp_theta_dcdm],
                                       ppt->has_source_theta_dcdm, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_theta_dr],
                                       ppt->has_source_theta_dr, storeidx);
                    if(pba->has_ndescf == _TRUE_)
                    {
                        for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
                        {
                            class_store_double(dataptr, tk[ppt->index_tp_bigtheta_ndescf1 + n_ndescf],
                                               ppt->has_source_delta_ndescf,
                                               storeidx);
                        }
                    }
                    class_store_double(dataptr, tk[ppt->index_tp_theta_scf],
                                       ppt->has_source_theta_scf, storeidx);
                    class_store_double(dataptr, tk[ppt->index_tp_theta_tot],
                                       ppt->has_source_theta_tot, storeidx);
            ...
            else if(output_format == camb_format)
            {
                ...
                class_store_double_or_default(dataptr, -tk[ppt->index_tp_delta_cdm] / k2,
                                              ppt->has_source_delta_cdm,
                                              storeidx, 0.0);
                class_store_double_or_default(dataptr, -tk[ppt->index_tp_delta_b] / k2,
                                              ppt->has_source_delta_b,
                                              storeidx, 0.0);
                class_store_double_or_default(dataptr, -tk[ppt->index_tp_delta_g] / k2,
                                              ppt->has_source_delta_g,
                                              storeidx, 0.0);
                class_store_double_or_default(dataptr, -tk[ppt->index_tp_delta_ur] / k2,
                                              ppt->has_source_delta_ur,
                                              storeidx, 0.0);
                class_store_double_or_default(dataptr, -tk[ppt->index_tp_delta_ncdm1] / k2,
                                              ppt->has_source_delta_ncdm, storeidx, 0.0);
                class_store_double_or_default(dataptr, -tk[ppt->index_tp_delta_tot] / k2,
                                              _TRUE_, storeidx, 0.0);
            }
        }
    }
...
{
    int n_ncdm, n_ndescf; // add ndescf index by Gen Ye;
    char tmp[40];
    ...
    if(output_format == class_format)
    {
        ...
        if(ppt->has_density_transfers == _TRUE_)
        {
            ...
            if(pba->has_ndescf == _TRUE_)
            {
                for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
                {
                    sprintf(tmp, "d_ndescf[%d]", n_ndescf);
                    class_store_columntitle(titles, tmp, _TRUE_);
                }
            }
        ...
        if(ppt->has_velocity_transfers == _TRUE_)
        {
            ...
            class_store_columntitle(titles, "t_cdm", ((pba->has_cdm == _TRUE_)
            ...
            if(pba->has_ndescf == _TRUE_)
            {
                for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
                {
                    sprintf(tmp, "bigt_ndescf[%d]", n_ndescf);
                    class_store_columntitle(titles, tmp, _TRUE_);
                }
            }
...
)
{
    ...
    if((ppt->has_ad == _TRUE_) && (index_ic == ppt->index_ic_ad))
    {
        strcpy(ic_suffix, "ad");
        strcpy(first_line,
               "for adiabatic (AD) mode (normalized to initial curvature=1) ");
    }
    ...
    if((ppt->has_bi == _TRUE_) && (index_ic == ppt->index_ic_bi))
    {
        strcpy(ic_suffix, "bi");
        strcpy(first_line,
               "for baryon isocurvature (BI) mode (normalized to initial entropy=1)");
    }
    ...
    if((ppt->has_cdi == _TRUE_) && (index_ic == ppt->index_ic_cdi))
    {
        ...
        strcpy(first_line,
               "for CDM isocurvature (CDI) mode (normalized to initial entropy=1)");
    }
...
)
{
    ...
    if(pba->has_idr == _TRUE_)
    {
        class_test((ppr->idr_streaming_approximation < rsa_idr_none) ||
                   ...
                   ppt->error_message,
                   "your idr_radiation_streaming_approximation is set to %d, out of range defined in perturbations.h",
    ...
    if(pba->has_fld == _TRUE_)
    {
        ...
        class_call(background_w_fld(pba, 0., &w_fld_ini, &dw_over_da_fld,
                                    &integral_fld),
                   pba->error_message, ppt->error_message);
        class_call(background_w_fld(pba, 1.,   &w_fld_0, &dw_over_da_fld,
                                    &integral_fld),
                   pba->error_message, ppt->error_message);

        class_test(w_fld_ini >= 0.,
                   ppt->error_message,
                   "The fluid is meant to be negligible at early time, and unimportant for defining the initial conditions of other species. You are using parameters for which this assumption may break down, since at early times you have w_fld(a--->0) = %e >= 0",
                   w_fld_ini);
    ...
    if(pba->has_dcdm == _TRUE_)
    {
        ...
        class_test((ppt->has_cdi == _TRUE_) || (ppt->has_bi == _TRUE_)
                   || (ppt->has_nid == _TRUE_)
                   || (ppt->has_niv == _TRUE_),
                   ppt->error_message,
    ...
    */
    ...
    class_alloc(pppw, number_of_threads * sizeof(struct perturbations_workspace *),
                ppt->error_message);
                    ...
                    if((ppt->perturbations_verbose > 2) && (abort == _FALSE_))
                    {
                        ...
                        if(pba->sgnK != 0)
                            printf(" (for scalar modes, corresponds to nu=%e)",
                                   sqrt(ppt->k[index_md][index_k]*ppt->k[index_md][index_k] + pba->K) / sqrt(
                                       pba->sgnK * pba->K));
                        printf("\n");
                    }
        ...
        for(index_md = 0; index_md < ppt->md_size; index_md++)
        {
            ...
            for(index_ic = 0; index_ic < ppt->ic_size[index_md]; index_ic++)
            {
                ...
                for(index_tp = 0; index_tp < ppt->tp_size[index_md]; index_tp++)
                {
                    ...
                    if(ppt->ln_tau_size > 1)
                        free(ppt->ddlate_sources[index_md][index_ic * ppt->tp_size[index_md] +
                                                           index_tp]);
...
)
{
    ...
    class_alloc(ppt->sources,       ppt->md_size * sizeof(double *),
                ppt->error_message);
    class_alloc(ppt->late_sources,  ppt->md_size * sizeof(double *),
                ppt->error_message);
    class_alloc(ppt->ddlate_sources, ppt->md_size * sizeof(double *),
                ppt->error_message);
    ...
    ppt->has_source_delta_ndescf = _FALSE_; // by Gen Ye
    ppt->has_source_delta_tot = _FALSE_;
    ...
    ppt->has_source_bigtheta_ndescf = _FALSE_; // by Gen Ye
    ppt->has_source_theta_tot = _FALSE_;
    ...
    class_define_index(ppt->index_tp_perturbed_recombination_delta_temp,
                       ppt->has_perturbed_recombination, index_type, 1);
    class_define_index(ppt->index_tp_perturbed_recombination_delta_chi,
                       ppt->has_perturbed_recombination, index_type, 1);
    ...
    for(index_md = 0; index_md < ppt->md_size; index_md++)
    {
        ...
        if(_scalars_)
        {
            ...
            if(ppt->has_density_transfers == _TRUE_)
            {
                ...
                if(pba-> has_ndescf == _TRUE_)         // ndescf by Gen Ye
                    ppt->has_source_delta_ndescf = _TRUE_;
            ...
            if(ppt->has_velocity_transfers == _TRUE_)
            {
                ...
                if(pba->has_ndescf == _TRUE_)         // ndescf by Gen Ye
                    ppt->has_source_bigtheta_ndescf = _TRUE_;
            }
            ...
            class_define_index(ppt->index_tp_t0,         ppt->has_source_t,
                               index_type, 1);
            class_define_index(ppt->index_tp_t1,         ppt->has_source_t,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_m,    ppt->has_source_delta_m,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_cb,   ppt->has_source_delta_cb,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_tot,  ppt->has_source_delta_tot,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_g,    ppt->has_source_delta_g,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_b,    ppt->has_source_delta_b,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_cdm,  ppt->has_source_delta_cdm,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_dcdm, ppt->has_source_delta_dcdm,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_fld,  ppt->has_source_delta_fld,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_scf,  ppt->has_source_delta_scf,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_dr,   ppt->has_source_delta_dr,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_ur,   ppt->has_source_delta_ur,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_idr,  ppt->has_source_delta_idr,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_idm_dr,  ppt->has_source_delta_idm_dr,
                               index_type, 1);
            class_define_index(ppt->index_tp_delta_ncdm1, ppt->has_source_delta_ncdm,
                               index_type, pba->N_ncdm);
            class_define_index(ppt->index_tp_delta_ndescf1, ppt->has_source_delta_ndescf,
                               index_type,
                               pba->N_ndescf); // additional scalar fields by Gen Ye
            class_define_index(ppt->index_tp_theta_m,    ppt->has_source_theta_m,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_cb,   ppt->has_source_theta_cb,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_tot,  ppt->has_source_theta_tot,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_g,    ppt->has_source_theta_g,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_b,    ppt->has_source_theta_b,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_cdm,  ppt->has_source_theta_cdm,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_dcdm, ppt->has_source_theta_dcdm,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_fld,  ppt->has_source_theta_fld,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_scf,  ppt->has_source_theta_scf,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_dr,   ppt->has_source_theta_dr,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_ur,   ppt->has_source_theta_ur,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_idr,  ppt->has_source_theta_idr,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_idm_dr,  ppt->has_source_theta_idm_dr,
                               index_type, 1);
            class_define_index(ppt->index_tp_theta_ncdm1, ppt->has_source_theta_ncdm,
                               index_type, pba->N_ncdm);
            class_define_index(ppt->index_tp_bigtheta_ndescf1,
                               ppt->has_source_bigtheta_ndescf, index_type,
                               pba->N_ndescf); // additional scalar fields by Gen Ye
            class_define_index(ppt->index_tp_phi,        ppt->has_source_phi,
                               index_type, 1);
            class_define_index(ppt->index_tp_phi_prime,  ppt->has_source_phi_prime,
                               index_type, 1);
            class_define_index(ppt->index_tp_phi_plus_psi, ppt->has_source_phi_plus_psi,
                               index_type, 1);
            class_define_index(ppt->index_tp_psi,        ppt->has_source_psi,
                               index_type, 1);
            class_define_index(ppt->index_tp_h,          ppt->has_source_h,
                               index_type, 1);
            class_define_index(ppt->index_tp_h_prime,    ppt->has_source_h_prime,
                               index_type, 1);
            class_define_index(ppt->index_tp_eta,        ppt->has_source_eta,
                               index_type, 1);
            class_define_index(ppt->index_tp_eta_prime,  ppt->has_source_eta_prime,
                               index_type, 1);
            class_define_index(ppt->index_tp_H_T_Nb_prime, ppt->has_source_H_T_Nb_prime,
                               index_type, 1);
            class_define_index(ppt->index_tp_k2gamma_Nb, ppt->has_source_k2gamma_Nb,
                               index_type, 1);
...
)
{
    ...
    double rate_ndescf; // oscillation timescale of ndescf by Gen Ye
    int n_ndescf; // ndescf index by Gen Ye
    ...
    */
    ...
    while(tau < pba->conformal_age)
    {
        ...
        if(ppt->has_cmb == _TRUE_)
        {
            ...
            rate_isw_squared = fabs(2.*a_primeprime_over_a - a_prime_over_a *
                                    a_prime_over_a);
        ...
        /* ndescf oscillation time scale by Gen Ye */
        if(pba->has_ndescf == _TRUE_)
        {
            for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
            {
                if(tau > pba->ndescf_tau_fld[pba->ndescf_sorted_index[n_ndescf]])
                {
                    continue;
                }
                else
                {
                    rate_ndescf = pvecback[pba->index_bg_a] * pba->ndescf_m_fld[pba->ndescf_sorted_index[n_ndescf]];
                    timescale_source = sqrt(rate_ndescf * rate_ndescf + timescale_source * timescale_source);
                    break;
                }
            }
        }
        ...
        class_test(fabs(ppr->perturbations_sampling_stepsize * timescale_source / tau) <
                   ppr->smallest_allowed_variation,
                   ppt->error_message,
                   "integration step =%e < machine precision : leads either to numerical error or infinite loop",
                   ppr->perturbations_sampling_stepsize * timescale_source);
    ...
    class_alloc(ppt->tau_sampling, ppt->tau_size * sizeof(double),
                ppt->error_message);
    ...
    else
    {
        ...
        class_test((tau_lower <= ppt->tau_sampling[index_tau]),
                   ppt->error_message,
                   "you asked for zmax=%e, i.e. taumin=%e, smaller than or equal to the first possible value =%e; it should be strictly bigger for a successfull interpolation",
                   ppt->z_max_pk, tau_lower, ppt->tau_sampling[0]);
        ...
        {
            ppt->ln_tau[index_tau] = log(ppt->tau_sampling[index_tau - ppt->ln_tau_size +
                                         ppt->tau_size]);
        }
    }
    ...
    for(index_md = 0; index_md < ppt->md_size; index_md++)
    {
        for(index_ic = 0; index_ic < ppt->ic_size[index_md]; index_ic++)
        {
            for(index_tp = 0; index_tp < ppt->tp_size[index_md]; index_tp++)
            {
                ...
                class_alloc(ppt->sources[index_md][index_ic * ppt->tp_size[index_md] +
                                                   index_tp],
                ...
                if(ppt->ln_tau_size > 1)
                {
                    ...
                    class_alloc(ppt->ddlate_sources[index_md][index_ic * ppt->tp_size[index_md] +
                                index_tp],
...
)
{
    ...
    if(ppt->has_scalars == _TRUE_)
    {
        ...
        else if(pba->sgnK == -1)
        {
            ...
            k_min = sqrt(-pba->K + pow(ppr->k_min_tau0 / pba->conformal_age /
                                       pth->angular_rescaling, 2));
        ...
        k_rec = 2. * _PI_ /
                pth->rs_rec; /* comoving scale corresponding to sound horizon at recombination */
        ...
        if(ppt->has_cls == _TRUE_)
        {
            ...
            k_max_cmb[ppt->index_md_scalars] = ppr->k_max_tau0_over_l_max *
                                               ppt->l_scalar_max
                    ...
                    || (ppt->has_cl_lensing_potential == _TRUE_))
            {
                ...
                k_max_cl[ppt->index_md_scalars] = MAX(k_max_cl[ppt->index_md_scalars],
                                                      ppr->k_max_tau0_over_l_max * ppt->l_lss_max / (pba->conformal_age -
        ...
        if((pba->has_idm_dr == _TRUE_) && (pth->nindex_idm_dr >= 2))
        {
            class_alloc(ppt->k[ppt->index_md_scalars],
                        ((int)((k_max_cmb[ppt->index_md_scalars] - k_min) / k_rec / MIN(
                                   ppr->k_step_super,
                                   ppr->k_step_sub)) +
        ...
        else
        {
            class_alloc(ppt->k[ppt->index_md_scalars],
                        ((int)((k_max_cmb[ppt->index_md_scalars] - k_min) / k_rec / MIN(
                                   ppr->k_step_super,
                                   ppr->k_step_sub)) +
                         (int)(MAX(ppr->k_per_decade_for_pk,
                                   ppr->k_per_decade_for_bao)*log(k_max / k_min) / log(10.)) + 3)
                        *sizeof(double), ppt->error_message);
        }
        ...
        while(k < k_max_cmb[ppt->index_md_scalars])
        {
            ...
            step *= (k * k / scale2 + 1.) / (k * k / scale2 + 1. /
        ...
        while(k < k_max_cl[ppt->index_md_scalars])
        {
            ...
            k *= pow(10., 1. / (ppr->k_per_decade_for_pk
                                ...
                                * (1. - tanh(pow((log(k) - log(ppr->k_bao_center * k_rec)) / log(
                                        ppr->k_bao_width), 4)))));
    ...
    if(ppt->has_vectors == _TRUE_)
    {
        ...
        if(ppt->has_cls == _TRUE_)
        {
            ...
            k_max_cmb[ppt->index_md_vectors] = ppr->k_max_tau0_over_l_max *
                                               ppt->l_vector_max
                                               / pba->conformal_age / pth->angular_rescaling;
        ...
        class_alloc(ppt->k[ppt->index_md_vectors],
                    ((int)((k_max_cmb[ppt->index_md_vectors] - k_min) / k_rec / MIN(
                               ppr->k_step_super,
                               ppr->k_step_sub)) + 1)
                    *sizeof(double), ppt->error_message);
    ...
    if(ppt->has_tensors == _TRUE_)
    {
        ...
        if(ppt->has_cls == _TRUE_)
        {
            ...
            k_max_cmb[ppt->index_md_tensors] = ppr->k_max_tau0_over_l_max *
                                               ppt->l_tensor_max
                                               / pba->conformal_age / pth->angular_rescaling;
        ...
        class_alloc(ppt->k[ppt->index_md_tensors],
                    ((int)((k_max_cmb[ppt->index_md_tensors] - k_min) / k_rec / MIN(
                               ppr->k_step_super,
                               ppr->k_step_sub)) + 1)
                    *sizeof(double), ppt->error_message);
    ...
    if(ppt->k_output_values_num > 0)
    {
        ...
        /* Allocate storage */
        class_alloc(ppt->index_k_output_values,
                    sizeof(double)*ppt->md_size * ppt->k_output_values_num,
                    ppt->error_message);
        ...
        for(index_mode = 0; index_mode < ppt->md_size; index_mode++)
        {
            ...
            for(index_newk = 0; index_newk < newk_size; index_newk++)
            {
                ...
                if(add_k_output_value == _TRUE_)
                {
                    ...
                    ppt->index_k_output_values[index_mode * ppt->k_output_values_num +
                                                          index_k_output] = index_newk;
                    index_k_output++;
                }
                else
                {
    ...
    */
    ...
    if(ppt->has_scalars == _TRUE_)
    {
        ppt->k_min = MIN(ppt->k_min,
                         ppt->k[ppt->index_md_scalars][0]); /* first value, inferred from perturbations structure */
        ppt->k_max = MAX(ppt->k_max,
                         ppt->k[ppt->index_md_scalars][ppt->k_size[ppt->index_md_scalars] -
                                 1]); /* last value, inferred from perturbations structure */
    }
    if(ppt->has_vectors == _TRUE_)
    {
        ppt->k_min = MIN(ppt->k_min,
                         ppt->k[ppt->index_md_vectors][0]); /* first value, inferred from perturbations structure */
        ppt->k_max = MAX(ppt->k_max,
                         ppt->k[ppt->index_md_vectors][ppt->k_size[ppt->index_md_vectors] -
                                 1]); /* last value, inferred from perturbations structure */
    }
    if(ppt->has_tensors == _TRUE_)
    {
        ppt->k_min = MIN(ppt->k_min,
                         ppt->k[ppt->index_md_tensors][0]); /* first value, inferred from perturbations structure */
        ppt->k_max = MAX(ppt->k_max,
                         ppt->k[ppt->index_md_tensors][ppt->k_size[ppt->index_md_tensors] -
                                 1]); /* last value, inferred from perturbations structure */
    }
...
)
{
    ...
    int index_ap;
    int l;
    int n_ndescf, index_k, idx_ndescf; // ndescf indices by Gen Ye
    ...
    if(_scalars_)
    {
        ...
        if((pba->has_idr == _TRUE_)
                && (ppt->idr_nature == idr_free_streaming)) ppw->max_l_max = MAX(ppw->max_l_max,
                            ppr->l_max_idr);
        if(pba->has_ncdm == _TRUE_) ppw->max_l_max = MAX(ppw->max_l_max,
                    ppr->l_max_ncdm);
    ...
    class_alloc(ppw->s_l, sizeof(double) * (ppw->max_l_max + 1),
                ppt->error_message);
    ...
    if(_scalars_)
    {
        ...
        if(ppt->gauge == synchronous)
        {
            ...
            class_define_index(ppw->index_mt_alpha, _TRUE_, index_mt,
    ...
    if(_scalars_)
    {
        ...
        class_define_index(ppw->index_ap_fa_ndescf1, pba->has_ndescf, index_ap,
                           pba->N_ndescf);
    ...
    if(_scalars_)
    {
        ...
        /* array to store min max delta and bigtheta immediately before turning on fld approx
         * for each wavenumber when ndescf KG is solved
         * needed for evaluating fld approx initial condition, by Gen Ye */
        if(pba->has_ndescf == _TRUE_)
        {
//            class_alloc(ppw->ndescf_delta_max, pba->N_ndescf * ppt->k_size[ppt->index_md_scalars] * sizeof(double), ppt->error_message);
//            class_alloc(ppw->ndescf_delta_min, pba->N_ndescf * ppt->k_size[ppt->index_md_scalars] * sizeof(double), ppt->error_message);
            class_alloc(ppw->ndescf_bigtheta_max, pba->N_ndescf * ppt->k_size[ppt->index_md_scalars] * sizeof(double), ppt->error_message);
            class_alloc(ppw->ndescf_bigtheta_min, pba->N_ndescf * ppt->k_size[ppt->index_md_scalars] * sizeof(double), ppt->error_message);

            /* initialize to some safe boundary value */
            idx_ndescf = 0;
            for(index_k = 0; index_k<ppt->k_size[ppt->index_md_scalars]; index_k++)
            {
                for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
                {
//                    ppw->ndescf_delta_max[idx_ndescf] = -1e10;
                    ppw->ndescf_bigtheta_max[idx_ndescf] = -1e10;
//                    ppw->ndescf_delta_min[idx_ndescf] = 1e10;
                    ppw->ndescf_bigtheta_min[idx_ndescf] = 1e10;
                    idx_ndescf ++;
                }
            }
        }
        ...
        {
            ppw->ndescf_bigtheta_max = NULL;
            ppw->ndescf_bigtheta_min = NULL;
        }
    }
...
)
{
    ...
    if(_scalars_)
    {
        ...
        // ndescf case by Gen Ye
        if(ppw->ndescf_bigtheta_max != NULL)
        {
            //free(ppw->ndescf_delta_max);
            //free(ppw->ndescf_delta_min);
            free(ppw->ndescf_bigtheta_max);
            free(ppw->ndescf_bigtheta_min);
        }
    }
...
)
{
    ...
    class_test(ppw->pvecback[pba->index_bg_a]*
               ...
               ppr->start_small_k_at_tau_c_over_tau_h, ppt->error_message,
               "your choice of initial time for integrating wavenumbers is inappropriate: it corresponds to a time before that at which the background has been integrated. You should increase 'start_small_k_at_tau_c_over_tau_h' up to at least %g, or decrease 'a_ini_over_a_today_default'\n",
    ...
    class_test(k / ppw->pvecback[pba->index_bg_a] / ppw->pvecback[pba->index_bg_H] >
               ...
               ppt->k[index_md][ppt->k_size[index_md] - 1] / ppw->pvecback[pba->index_bg_a] /
               ppw->pvecback[pba->index_bg_H]);
    ...
    if(pba->has_ncdm == _TRUE_)
    {
        for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
        {
            class_test(fabs(ppw->pvecback[pba->index_bg_p_ncdm1 + n_ncdm] /
                            ppw->pvecback[pba->index_bg_rho_ncdm1 + n_ncdm] - 1. / 3.) >
    ...
    while((tau_upper - tau_lower) / tau_lower > ppr->tol_tau_approx)
    {
        ...
        if(pba->has_ncdm == _TRUE_)
        {
            for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
            {
                if(fabs(ppw->pvecback[pba->index_bg_p_ncdm1 + n_ncdm] /
                        ppw->pvecback[pba->index_bg_rho_ncdm1 +
                                                              n_ncdm] - 1. / 3.) > ppr->tol_ncdm_initial_w)
                    is_early_enough = _FALSE_;
            }
        }

        /* Do we wnat to check whether all ndescf are initially frozen? by Gen Ye */
        if(pba->has_ndescf == _TRUE_)
        {
            // TODO
        }
    ...
    class_alloc(interval_limit, (interval_number + 1)*sizeof(double),
                ppt->error_message);

    class_alloc(interval_approx, interval_number * sizeof(int*),
                ppt->error_message);

    for(index_interval = 0; index_interval < interval_number; index_interval++)
        class_alloc(interval_approx[index_interval], ppw->ap_size * sizeof(int),
                    ppt->error_message);
    ...
    {
        if(ppt->index_k_output_values[index_md * ppt->k_output_values_num + index_ikout]
                == index_k)
        {
    ...
    //printf("Purturbation integration finised for k=%g\n",k);
                                   ...
                                   struct perturbations * ppt)
{
    ...
    if(ppt->k_output_values_num > 0)
    {
        ...
        if(ppt->has_scalars == _TRUE_)
        {
            ...
            class_store_columntitle(ppt->scalar_titles, "delta_Tb",
                                    ppt->has_perturbed_recombination);
            class_store_columntitle(ppt->scalar_titles, "delta_chi",
                                    ppt->has_perturbed_recombination);
            ...
            if(pba->has_ndescf == _TRUE_)
            {
                for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
                {
                    sprintf(tmp, "delta_ndescf[%d]", n_ndescf);
                    class_store_columntitle(ppt->scalar_titles, tmp, _TRUE_);
                    sprintf(tmp, "bigtheta_ndescf[%d]", n_ndescf);
                    class_store_columntitle(ppt->scalar_titles, tmp, _TRUE_);
                    sprintf(tmp, "cs2_eff_ndescf[%d]", n_ndescf);
                    class_store_columntitle(ppt->scalar_titles, tmp, _TRUE_);
                    sprintf(tmp, "delta_phi_ndescf[%d]", n_ndescf);
                    class_store_columntitle(ppt->scalar_titles, tmp, _TRUE_);
                    sprintf(tmp, "delta_phi_prime_ndescf[%d]", n_ndescf);
                    class_store_columntitle(ppt->scalar_titles, tmp, _TRUE_);
                }
            }
            ...
            /* more scf output, by Gen Ye */
            class_store_columntitle(ppt->scalar_titles, "delta_phi_scf", pba->has_scf);
            class_store_columntitle(ppt->scalar_titles, "delta_phi_prime_scf",
                                    pba->has_scf);
            ...
            class_store_columntitle(ppt->scalar_titles, "rho_plus_p_theta_fld",
                                    pba->has_fld);
...
)
{
    ...
    int n_ndescf; // index for ndescf by Gen Ye
    ...
    else
    {
        ...
        class_alloc(unsorted_tau_switch, (interval_number - 1)*sizeof(double),
                    ppt->error_message);
        ...
        for(index_switch = 1; index_switch < interval_number; index_switch++)
        {
            ...
            for(index_ap = 0; index_ap < ppw->ap_size; index_ap++)
            {
                if(interval_approx[index_switch][index_ap] != interval_approx[index_switch -
                        1][index_ap])
            ...
            if(ppt->perturbations_verbose > 2)
            {
                ...
                if(_scalars_)
                {
                    ...
                    if(pba->has_idr == _TRUE_)
                    {
                        if((interval_approx[index_switch - 1][ppw->index_ap_rsa_idr] ==
                                (int)rsa_idr_off) &&
                                (interval_approx[index_switch][ppw->index_ap_rsa_idr] == (int)rsa_idr_on))
                            fprintf(stdout,
                                    "Mode k=%e: will switch on dark radiation streaming approximation at tau=%e\n",
                                    k,
                                    interval_limit[index_switch]);
                    }
                    ...
                    if(pba->has_idm_dr == _TRUE_)
                    {
                        if((interval_approx[index_switch - 1][ppw->index_ap_tca_idm_dr] ==
                                (int)tca_idm_dr_on) &&
                                (interval_approx[index_switch][ppw->index_ap_tca_idm_dr] ==
                                 (int)tca_idm_dr_off))
                            fprintf(stdout,
                    ...
                    if(pba->has_ndescf == _TRUE_) // case of ndescf by Gen Ye
                    {
                        for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
                        {
                            if((interval_approx[index_switch - 1][ppw->index_ap_fa_ndescf1 + n_ndescf] ==
                                    (int)fa_ndescf_off) &&
                                    (interval_approx[index_switch][ppw->index_ap_fa_ndescf1 + n_ndescf] ==
                                     (int)fa_ndescf_on))
                            {
                                fprintf(stdout,
                                        "Mode k=%e: will switch on ndescf fluid approximation at tau=%e\n for field Nr.%d",
                                        k,
                                        interval_limit[index_switch], n_ndescf);
                            }
                        }
                ...
                if(_tensors_)
                {
                    ...
                    if((interval_approx[index_switch - 1][ppw->index_ap_tca] == (int)tca_on) &&
                            (interval_approx[index_switch][ppw->index_ap_tca] == (int)tca_off))
                        fprintf(stdout,
                                "Mode k=%e: will switch off tight-coupling approximation for tensors at tau=%e\n",
                                k, interval_limit[index_switch]);

                    if((interval_approx[index_switch - 1][ppw->index_ap_rsa] == (int)rsa_off) &&
                            (interval_approx[index_switch][ppw->index_ap_rsa] == (int)rsa_on))
                        fprintf(stdout,
                                "Mode k=%e: will switch on radiation streaming approximation for tensors at tau=%e\n",
                                k,
                                interval_limit[index_switch]);
...
)
{
    ...
    int n_ndescf, idx_ndescf; // ndescf indices by Gen Ye
    double dphi, dphi_prime, a2; // ndescf short hand variables by Gen Ye
    ...
    if(_scalars_)
    {
        ...
        if(ppw->approx[ppw->index_ap_rsa] == (int)
                rsa_off)    /* if radiation streaming approximation is off */
        {
            ...
            class_define_index(ppv->index_pt_delta_g, _TRUE_, index_pt,
                               1); /* photon density */
            class_define_index(ppv->index_pt_theta_g, _TRUE_, index_pt,
                               1); /* photon velocity */

            if(ppw->approx[ppw->index_ap_tca] == (int)tca_off)
            {

                class_define_index(ppv->index_pt_shear_g, _TRUE_, index_pt,
                                   1); /* photon shear */
                class_define_index(ppv->index_pt_l3_g, _TRUE_, index_pt,
                                   ppv->l_max_g - 2); /* higher momenta */
                ...
                class_define_index(ppv->index_pt_pol3_g, _TRUE_, index_pt,
                                   ppv->l_max_pol_g - 2);
            }
        }
        ...
        class_define_index(ppv->index_pt_delta_b, _TRUE_, index_pt,
                           1); /* baryon density */
        class_define_index(ppv->index_pt_theta_b, _TRUE_, index_pt,
                           1); /* baryon velocity */

        /* cdm */

        class_define_index(ppv->index_pt_delta_cdm, pba->has_cdm, index_pt,
                           1); /* cdm density */
        class_define_index(ppv->index_pt_theta_cdm, pba->has_cdm
                           && (ppt->gauge == newtonian), index_pt, 1); /* cdm velocity */

        /* idm_dr */

        class_define_index(ppv->index_pt_delta_idm_dr, pba->has_idm_dr, index_pt,
                           1); /* idm_dr density */
        class_define_index(ppv->index_pt_theta_idm_dr, pba->has_idm_dr, index_pt,
                           1); /* idm_dr velocity */

        /* dcdm */

        class_define_index(ppv->index_pt_delta_dcdm, pba->has_dcdm, index_pt,
                           1); /* dcdm density */
        class_define_index(ppv->index_pt_theta_dcdm, pba->has_dcdm, index_pt,
                           1); /* dcdm velocity */
        ...
        if(pba->has_dr == _TRUE_)
        {
            ...
            class_define_index(ppv->index_pt_F0_dr, _TRUE_, index_pt,
                               ppv->l_max_dr + 1); /* all momenta in Boltzmann hierarchy  */
        }
        ...
        if(pba->use_ppf == _FALSE_)
        {
            class_define_index(ppv->index_pt_delta_fld, pba->has_fld, index_pt,
                               1); /* fluid density */
            class_define_index(ppv->index_pt_theta_fld, pba->has_fld, index_pt,
                               1); /* fluid velocity */
        }
        else
        {
            class_define_index(ppv->index_pt_Gamma_fld, pba->has_fld, index_pt,
                               1); /* Gamma variable of PPF scheme */
        }

        /* non dark energy scalar fields by Gen Ye
        /* When KG is integrated: x1=phi, x2=phi_prime
        /* When fld is integrated: x1=delta, x2=bigtheta */
        class_define_index(ppv->index_pt_x1_ndescf1, pba->has_ndescf, index_pt,
                           pba->N_ndescf);
        class_define_index(ppv->index_pt_x2_ndescf1, pba->has_ndescf, index_pt,
                           pba->N_ndescf);

        /* scalar field */

        class_define_index(ppv->index_pt_phi_scf, pba->has_scf, index_pt,
                           1); /* scalar field density */
        class_define_index(ppv->index_pt_phi_prime_scf, pba->has_scf, index_pt,
                           1); /* scalar field velocity */
        ...
        {
            class_define_index(ppv->index_pt_perturbed_recombination_delta_temp, _TRUE_,
                               index_pt, 1);
            class_define_index(ppv->index_pt_perturbed_recombination_delta_chi, _TRUE_,
                               index_pt, 1);
        }
        ...
        if(pba->has_ur && (ppw->approx[ppw->index_ap_rsa] == (int)rsa_off))
        {
            ...
            class_define_index(ppv->index_pt_delta_ur, _TRUE_, index_pt,
                               1); /* density of ultra-relativistic neutrinos/relics */
            class_define_index(ppv->index_pt_theta_ur, _TRUE_, index_pt,
                               1); /* velocity of ultra-relativistic neutrinos/relics */
            class_define_index(ppv->index_pt_shear_ur, _TRUE_, index_pt,
                               1); /* shear of ultra-relativistic neutrinos/relics */

            if(ppw->approx[ppw->index_ap_ufa] == (int)ufa_off)
            {
                ppv->l_max_ur = ppr->l_max_ur;
                class_define_index(ppv->index_pt_l3_ur, _TRUE_, index_pt,
                                   ppv->l_max_ur -
        ...
        if(pba->has_idr == _TRUE_)
        {
            ...
            {
                class_define_index(ppv->index_pt_delta_idr, _TRUE_, index_pt,
                                   1); /* density of interacting dark radiation */
                class_define_index(ppv->index_pt_theta_idr, _TRUE_, index_pt,
                                   1); /* velocity of interacting dark radiation */
                if(ppt->idr_nature == idr_free_streaming)
                {
                    if((pba->has_idm_dr == _FALSE_) || ((pba->has_idm_dr == _TRUE_)
                                                        && (ppw->approx[ppw->index_ap_tca_idm_dr] == (int)tca_idm_dr_off)))
                    {
                        class_define_index(ppv->index_pt_shear_idr, _TRUE_, index_pt,
                                           1); /* shear of interacting dark radiation */
                        ppv->l_max_idr = ppr->l_max_idr;
                        class_define_index(ppv->index_pt_l3_idr, _TRUE_, index_pt,
                                           ppv->l_max_idr -
                                           2); /* additional momenta in Boltzmann hierarchy (beyond l=0,1,2,3) */
                    }
                }
        ...
        if(pba->has_ncdm == _TRUE_)
        {
            ppv->index_pt_psi0_ncdm1 =
                index_pt; /* density of ultra-relativistic neutrinos/relics */
            ...
            for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
            {
                ...
                if(ppw->approx[ppw->index_ap_ncdmfa] == (int)ncdmfa_off)
                {
                    ...
                    class_test(ppr->l_max_ncdm < 4,
                               ppt->error_message,
                               "ppr->l_max_ncdm=%d should be at least 4, i.e. we must integrate at least over first four momenta of non-cold dark matter perturbed phase-space distribution",
                               n_ncdm);
    ...
    if(_vectors_)
    {
        ...
        if(ppw->approx[ppw->index_ap_rsa] == (int)
                rsa_off)    /* if radiation streaming approximation is off */
        {
            if(ppw->approx[ppw->index_ap_tca] == (int)
                    tca_off)    /* if tight-coupling approximation is off */
            {
                ...
                class_define_index(ppv->index_pt_shear_g, _TRUE_, index_pt,
                                   1); /* photon shear */
                class_define_index(ppv->index_pt_l3_g, _TRUE_, index_pt,
                                   ppv->l_max_g - 2); /* photon l=3 */

                ppv->l_max_pol_g = ppr->l_max_pol_g_ten;

                class_define_index(ppv->index_pt_pol0_g, _TRUE_, index_pt,
                                   1); /* photon polarization, l=0 */
                class_define_index(ppv->index_pt_pol1_g, _TRUE_, index_pt,
                                   1); /* photon polarization, l=1 */
                class_define_index(ppv->index_pt_pol2_g, _TRUE_, index_pt,
                                   1); /* photon polarization, l=2 */
                class_define_index(ppv->index_pt_pol3_g, _TRUE_, index_pt,
                                   ppv->l_max_pol_g - 2); /* photon polarization, l=3 */
            }
        }
    ...
    if(_tensors_)
    {
        ...
        class_define_index(ppv->index_pt_delta_ur, ppt->evolve_tensor_ur, index_pt,
                           1); /* ur density  */
        class_define_index(ppv->index_pt_theta_ur, ppt->evolve_tensor_ur, index_pt,
                           1); /* ur velocity */
        class_define_index(ppv->index_pt_shear_ur, ppt->evolve_tensor_ur, index_pt,
                           1); /* ur shear */
        ppv->l_max_ur = ppr->l_max_ur;
        class_define_index(ppv->index_pt_l3_ur, ppt->evolve_tensor_ur, index_pt,
                           ppv->l_max_ur -
                           2); /* additional momenta in Boltzmann hierarchy (beyond l=0,1,2,3) */
    ...
    class_alloc(ppv->used_in_sources, ppv->pt_size * sizeof(int),
                ppt->error_message);
    ...
    if(_scalars_)
    {
        ...
        if(ppw->approx[ppw->index_ap_rsa] == (int)rsa_off)
        {
            ...
            if(ppw->approx[ppw->index_ap_tca] == (int)tca_off)
            {
                ...
                for(index_pt = ppv->index_pt_l3_g;
                        index_pt <= ppv->index_pt_delta_g + ppv->l_max_g; index_pt++)
                ...
                for(index_pt = ppv->index_pt_pol3_g;
        ...
        if(pba->has_ur == _TRUE_)
        {
            ...
            if(ppw->approx[ppw->index_ap_rsa] == (int)rsa_off)
            {
                ...
                if(ppw->approx[ppw->index_ap_ufa] == (int)ufa_off)
                {
                    ...
                    for(index_pt = ppv->index_pt_l3_ur;
                            index_pt <= ppv->index_pt_delta_ur + ppv->l_max_ur; index_pt++)
                        ppv->used_in_sources[index_pt] = _FALSE_;
    ...
    if(_tensors_)
    {
                ...
                rsa_off)    /* if radiation streaming approximation is off */
        {
            if(ppw->approx[ppw->index_ap_tca] == (int)tca_off)
            {
                ...
                for(index_pt = ppv->index_pt_delta_g + 5;
                        index_pt <= ppv->index_pt_delta_g + ppv->l_max_g;
                        index_pt++)
                    ppv->used_in_sources[index_pt] = _FALSE_;
    ...
    else
    {
        ...
        if(_scalars_)
        {
            ...
            /* case of ndescf by Gen Ye */
            if(pba->has_ndescf == _TRUE_)
            {
                // if ndescf fld approx changes, it is overwriten by the correct values later
                for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
                {
                    ppv->y[ppv->index_pt_x1_ndescf1 + n_ndescf] =
                        ppw->pv->y[ppw->pv->index_pt_x1_ndescf1 +
                                                                n_ndescf];
                    ppv->y[ppv->index_pt_x2_ndescf1 + n_ndescf] =
                        ppw->pv->y[ppw->pv->index_pt_x2_ndescf1 +
                                                                n_ndescf];
                }
            }
                    ...
                    && (ppw->approx[ppw->index_ap_tca] == (int)tca_off))
            {
                ...
                if(ppt->perturbations_verbose > 2)
                    fprintf(stdout,
                            "Mode k=%e: switch off tight-coupling approximation at tau=%e\n", k, tau);
                ...
                ppv->y[ppv->index_pt_pol0_g] = 2.5 *
                                               ppv->y[ppv->index_pt_shear_g];                                                            /* first-order tight-coupling approximation for polarization, l=0 */
                ppv->y[ppv->index_pt_pol1_g] = k / ppw->pvecthermo[pth->index_th_dkappa] *
                                               (5. - 2.*ppw->s_l[2]) /
                                               6.*ppv->y[ppv->index_pt_shear_g]; /* second-order tight-coupling approximation for polarization, l=1 */
                ppv->y[ppv->index_pt_pol2_g] = 0.5 *
                                               ppv->y[ppv->index_pt_shear_g];                                                            /* first-order tight-coupling approximation for polarization, l=2 */
                ppv->y[ppv->index_pt_pol3_g] = k / ppw->pvecthermo[pth->index_th_dkappa] *
                                               3.*ppw->s_l[3] /
                                               14.*ppv->y[ppv->index_pt_shear_g];     /* second-order tight-coupling approximation for polarization, l=3 */
                ...
                if(ppt->has_perturbed_recombination == _TRUE_)
                {
                    ppv->y[ppv->index_pt_perturbed_recombination_delta_temp] = 1. /
                            3.*ppv->y[ppw->pv->index_pt_delta_b];
                    ...
                    && (ppw->approx[ppw->index_ap_rsa] == (int)rsa_on))
            {
                ...
                if(ppt->perturbations_verbose > 2)
                    fprintf(stdout,
                            "Mode k=%e: switch on radiation streaming approximation at tau=%e with Omega_r=%g\n",
                            k, tau,
                            ppw->pvecback[pba->index_bg_Omega_r]);
                        ...
                        && (ppw->approx[ppw->index_ap_tca_idm_dr] == (int)tca_idm_dr_off))
                {
                    ...
                    if(ppw->approx[ppw->index_ap_rsa] == (int)rsa_idr_off)
                    {
                        ...
                        if(ppt->idr_nature == idr_free_streaming)
                        {
                            ...
                            ppv->y[ppv->index_pt_l3_idr] = 6. / 7.*k * ppv->y[ppv->index_pt_shear_idr] /
                                                           ppw->pvecthermo[pth->index_th_dmu_idm_dr] / ppt->alpha_idm_dr[1];
                        }
                    }
            ...
            if(pba->has_ncdm == _TRUE_)
            {
                        ...
                        && (ppw->approx[ppw->index_ap_ncdmfa] == (int)ncdmfa_on))
                {
                    ...
                    for(n_ncdm = 0; n_ncdm < ppv->N_ncdm; n_ncdm++)
                    {
                        ...
                        ppv->y[ppv->index_pt_psi0_ncdm1 + ncdm_l_size * n_ncdm] *= factor /
                                ppw->pvecback[pba->index_bg_rho_ncdm1 + n_ncdm];
                        ppv->y[ppv->index_pt_psi0_ncdm1 + ncdm_l_size * n_ncdm + 1] *= k * factor /
                                rho_plus_p_ncdm;
                        ppv->y[ppv->index_pt_psi0_ncdm1 + ncdm_l_size * n_ncdm + 2] *= 2.0 / 3.0 *
                                factor / rho_plus_p_ncdm;
                    }
                }
            }

            /* -- case of switching on ndescf fluid approximation by Gen Ye */
            if(pba->has_ndescf == _TRUE_)
            {
                for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
                {
                    if(pa_old[ppw->index_ap_fa_ndescf1 + n_ndescf] ==
                            ppw->approx[ppw->index_ap_fa_ndescf1 + n_ndescf])
                    {
                        continue;
                    }
                    else
                    {
                        if(ppt->perturbations_verbose > 2)
                            fprintf(stdout,
                                    "Mode k=%e: switch on ndescf fluid approximation at tau=%e for field Nr.%d\n",
                                    k,
                                    tau, n_ndescf);
                        // length of y does not change in this case, first copy everything to the new vector
                        class_protect_memcpy(ppv->y, ppw->pv->y, sizeof(double)*ppv->pt_size);
                        // now calculate delta and theta from delta_phi and delta_phi_prime
                        // some short handed variables
                        a2 = ppw->pvecback[pba->index_bg_a] * ppw->pvecback[pba->index_bg_a];
                        dphi = ppw->pv->y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf];
                        dphi_prime = ppw->pv->y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf];
                        idx_ndescf = pba->N_ndescf*index_k+n_ndescf;
                        ppv->y[ppv->index_pt_x1_ndescf1 + n_ndescf] = 1. / 3. * (1. / a2 *
                                ppw->pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf] * dphi_prime +
                                ppw->pvecback[pba->index_bg_dV_ndescf1 + n_ndescf] * dphi) / ppw->pvecback[pba->index_bg_rho_ndescf1
                                        + n_ndescf];
//                        ppv->y[ppv->index_pt_x1_ndescf1 + n_ndescf] = 0.5 * (ppw->ndescf_delta_max[idx_ndescf]+ppw->ndescf_delta_min[idx_ndescf]);
                        // big_theta = k^2/a^2 * phi_prime * delta_phi / 3
//                        ppv->y[ppv->index_pt_x2_ndescf1 + n_ndescf] = 1. / 3.* k * k / a2 *
//                                ppw->pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf] * dphi /
//                                ppw->pvecback[pba->index_bg_rho_ndescf1 + n_ndescf];
                        ppv->y[ppv->index_pt_x2_ndescf1 + n_ndescf] = 0.5 * (ppw->ndescf_bigtheta_max[idx_ndescf]+ppw->ndescf_bigtheta_min[idx_ndescf]);
                        // only one approx scheme is flipped at a time, thus we terminate here
                        break;
                    }
                }
            }
                                    ...
                                    )
{
    ...
    double cs2_eff, ma;  // convenience variables for ndescf fld approx by Gen Ye
    double delta_ur = 0., theta_ur = 0., shear_ur = 0., l3_ur = 0., eta = 0.,
           delta_cdm = 0., alpha,
           alpha_prime;
    double delta_dr = 0;
    double q, epsilon, k2;
    int index_q, n_ncdm, idx, n_ndescf;
    ...
    if(_scalars_)
    {
        ...
        /* add ndescf by Gen Ye */
        if(pba->has_ndescf == _TRUE_)
        {
            for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
            {
                rho_r += 3.*ppw->pvecback[pba->index_bg_p_ndescf1 + n_ndescf];
                rho_m += ppw->pvecback[pba->index_bg_rho_ndescf1 + n_ndescf] - 3.*
                         ppw->pvecback[pba->index_bg_p_ndescf1 + n_ndescf];
            }
        }

        /* ede scf might be relevant so add scf, by Gen Ye */
        if(pba->has_scf == _TRUE_)
        {
            rho_r += 3.*ppw->pvecback[pba->index_bg_p_scf];
            rho_m += ppw->pvecback[pba->index_bg_rho_scf] - 3.*
        ...
        */
        ...
        if((ppt->has_ad == _TRUE_) && (index_ic == ppt->index_ic_ad))
        {
            ...
            /* photon velocity */
            ppw->pv->y[ppw->pv->index_pt_theta_g] = - k * ktau_three / 36. * (1. - 3.*
                                                    (1. + 5.*fracb - fracnu) / 20. / (1. - fracnu) * om * tau)
                                                    * ppr->curvature_ini * s2_squared;

            /* tighly-coupled baryons */
            ppw->pv->y[ppw->pv->index_pt_delta_b] = 3. /
                                                    4.*ppw->pv->y[ppw->pv->index_pt_delta_g]; /* baryon density */
            ppw->pv->y[ppw->pv->index_pt_theta_b] =
                ppw->pv->y[ppw->pv->index_pt_theta_g]; /* baryon velocity */

            if(pba->has_cdm == _TRUE_)
            {
                ppw->pv->y[ppw->pv->index_pt_delta_cdm] = 3. /
                        4.*ppw->pv->y[ppw->pv->index_pt_delta_g]; /* cdm density */
            ...
            if(pba->has_idm_dr == _TRUE_)
            {
                ppw->pv->y[ppw->pv->index_pt_delta_idm_dr] = 3. /
                        4.*ppw->pv->y[ppw->pv->index_pt_delta_g]; /* idm_dr density */
            }

            if(pba->has_dcdm == _TRUE_)
            {
                ppw->pv->y[ppw->pv->index_pt_delta_dcdm] = 3. /
                        4.*ppw->pv->y[ppw->pv->index_pt_delta_g]; /* dcdm density */
                /* dcdm velocity velocity vanishes initially in the synchronous gauge */

            }

            /* non dark energy scalar field initial conditions by Gen Ye.
             * If initially KG is solved, delta_phi and delta_phi_prime assumed to be zero, set by default.
             * If fluid approx is used we use the fld IC. */
            if(pba->has_ndescf == _TRUE_)
            {
                for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
                {
                    if(ppw->approx[ppw->index_ap_fa_ndescf1 + n_ndescf] == (int)fa_ndescf_off)
                    {
                        continue;
                    }
                    else
                    {
                        ...
                        /* cs2_eff determined by potential type, add here if new potential is implemented
                         * currently only support axion */
                        if(pba->ndescf_parameters[pba->ndescf_parameters_size * (n_ndescf + 1) - 3] < 0)
                        {
                            ma = pba->ndescf_parameters[pba->ndescf_parameters_size * n_ndescf + 1];
                            cs2_eff = k * k / (4 * ma * ma * a * a) / (1 + k * k / (4 * ma * ma * a * a));
                        }
                        // delta
                        ppw->pv->y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf] = - ktau_two / 4.*
                                (1. + w_fld) *
                                (4. - 3.*cs2_eff) /
                                (4. - 6.*w_fld + 3.*cs2_eff) * ppr->curvature_ini *
                                s2_squared; /* from 1004.5509 */ //TBC: curvature
                        // big_theta
                        ppw->pv->y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf] = -
                                (1. + w_fld) * k * ktau_three / 4.*cs2_eff /
                                s2_squared; /* from 1004.5509 */ //TBC:curvature
                    }
                }
            }
            ...
            if(pba->has_fld == _TRUE_)
            {
                ...
                if(pba->use_ppf == _FALSE_)
                {
                    ppw->pv->y[ppw->pv->index_pt_delta_fld] = - ktau_two / 4.*(1. + w_fld) *
                            (4. - 3.*pba->cs2_fld) /
                            (4. - 6.*w_fld + 3.*pba->cs2_fld) * ppr->curvature_ini *
                            s2_squared; /* from 1004.5509 */ //TBC: curvature
                    ...
                    || (pba->has_idr == _TRUE_))
            {
                ...
                delta_ur =
                    ppw->pv->y[ppw->pv->index_pt_delta_g]; /* density of ultra-relativistic neutrinos/relics */

                /* velocity of ultra-relativistic neutrinos/relics */ //TBC
                theta_ur = - k * ktau_three / 36. / (4.*fracnu + 15.) *
                           (4.*fracnu + 11. + 12.*s2_squared - 3.*
                            (8.*fracnu * fracnu + 50.*fracnu + 275.) / 20. / (2.*fracnu + 15.) * tau * om) *
                           ppr->curvature_ini
                           * s2_squared;

                shear_ur = ktau_two / (45. + 12.*fracnu) * (3.*s2_squared - 1.) * (1. +
                           (4.*fracnu - 5.) / 4. /
                           (2.*fracnu + 15.) * tau * om) *
            ...
            eta = ppr->curvature_ini * (1. - ktau_two / 12. / (15. + 4.*fracnu) *
                                        (5. + 4.*s2_squared * fracnu - (16.*fracnu * fracnu + 280.*fracnu + 325) / 10. /
                                         (2.*fracnu + 15.) * tau * om));
        ...
        if((ppt->has_cdi == _TRUE_) && (index_ic == ppt->index_ic_cdi))
        {
            ...
            ppw->pv->y[ppw->pv->index_pt_delta_g] = ppr->entropy_ini * fraccdm * om * tau *
                                                    (-2. / 3. + om * tau / 4.);
            ppw->pv->y[ppw->pv->index_pt_theta_g] = -ppr->entropy_ini * fraccdm * om *
                                                    ktau_two / 12.;

            ppw->pv->y[ppw->pv->index_pt_delta_b] = 3. /
                                                    4.*ppw->pv->y[ppw->pv->index_pt_delta_g];
            ppw->pv->y[ppw->pv->index_pt_theta_b] = ppw->pv->y[ppw->pv->index_pt_theta_g];

            ppw->pv->y[ppw->pv->index_pt_delta_cdm] = ppr->entropy_ini + 3. /
                    4.*ppw->pv->y[ppw->pv->index_pt_delta_g];
            ...
            if((pba->has_ur == _TRUE_) || (pba->has_ncdm == _TRUE_))
            {
                ...
                shear_ur = -ppr->entropy_ini * fraccdm * ktau_two * tau * om / 6. /
                           (2.*fracnu + 15.);
        ...
        if((ppt->has_bi == _TRUE_) && (index_ic == ppt->index_ic_bi))
        {
            ...
            ppw->pv->y[ppw->pv->index_pt_delta_g] = ppr->entropy_ini * fracb * om * tau *
                                                    (-2. / 3. + om * tau / 4.);
            ppw->pv->y[ppw->pv->index_pt_theta_g] = -ppr->entropy_ini * fracb * om *
                                                    ktau_two / 12.;

            ppw->pv->y[ppw->pv->index_pt_delta_b] = ppr->entropy_ini + 3. /
                                                    4.*ppw->pv->y[ppw->pv->index_pt_delta_g];
            ppw->pv->y[ppw->pv->index_pt_theta_b] = ppw->pv->y[ppw->pv->index_pt_theta_g];
            ...
            if((pba->has_ur == _TRUE_) || (pba->has_ncdm == _TRUE_))
            {
                ...
                delta_ur = ppw->pv->y[ppw->pv->index_pt_delta_g];
                theta_ur = ppw->pv->y[ppw->pv->index_pt_theta_g];
                shear_ur = -ppr->entropy_ini * fracb * ktau_two * tau * om / 6. /
                           (2.*fracnu + 15.);
        ...
        if((ppt->has_nid == _TRUE_) && (index_ic == ppt->index_ic_nid))
        {
            ...
            ppw->pv->y[ppw->pv->index_pt_delta_g] = ppr->entropy_ini * fracnu / fracg *
                                                    (-1. + ktau_two / 6.);
            ppw->pv->y[ppw->pv->index_pt_theta_g] = -ppr->entropy_ini * fracnu / fracg * k *
                                                    k * tau *
                                                    (1. / 4. - fracb / fracg * 3. / 16.*om * tau);

            ppw->pv->y[ppw->pv->index_pt_delta_b] = ppr->entropy_ini * fracnu / fracg /
                                                    8.*ktau_two;
            ppw->pv->y[ppw->pv->index_pt_theta_b] = ppw->pv->y[ppw->pv->index_pt_theta_g];
            ...
            if(pba->has_cdm == _TRUE_)
            {
                ...
                ppw->pv->y[ppw->pv->index_pt_delta_cdm] = -ppr->entropy_ini * fracnu * fracb /
                        fracg / 80.*ktau_two
                        * om * tau;
        ...
        if((ppt->has_niv == _TRUE_) && (index_ic == ppt->index_ic_niv))
        {
            ...
            ppw->pv->y[ppw->pv->index_pt_delta_g] = ppr->entropy_ini * k * tau * fracnu /
                                                    fracg *
                                                    (1. - 3. / 16.*fracb * (2. + fracg) / fracg * om *
                                                            tau); /* small diff wrt camb */

            ppw->pv->y[ppw->pv->index_pt_theta_g] = ppr->entropy_ini * fracnu / fracg * 3. /
                                                    4.*k *
                                                    (-1. + 3. / 4.*fracb / fracg * om * tau + 3. / 16.*om * om * tau * tau * fracb /
                                                            fracg / fracg *
                                                            (fracg - 3.*fracb) + ktau_two / 6.);

            ppw->pv->y[ppw->pv->index_pt_delta_b] = 3. /
                                                    4.*ppw->pv->y[ppw->pv->index_pt_delta_g]; /* small diff wrt camb */
            ppw->pv->y[ppw->pv->index_pt_theta_b] = ppw->pv->y[ppw->pv->index_pt_theta_g];

            if(pba->has_cdm == _TRUE_)
            {

                ppw->pv->y[ppw->pv->index_pt_delta_cdm] = -ppr->entropy_ini * 9. / 64.*fracnu *
                        fracb / fracg * k *
                        tau * om * tau;

            }

            delta_ur = -ppr->entropy_ini * k * tau * (1. + 3. / 16.*fracb * fracnu / fracg *
                       om *
                       tau); /* small diff wrt camb */
            theta_ur = ppr->entropy_ini * 3. / 4.*k * (1. - 1. / 6.*ktau_two *
                       (4.*fracnu + 9.) /
                       (4.*fracnu + 5.));
            shear_ur = ppr->entropy_ini / (4.*fracnu + 15.) * k * tau *
                       (1. + 3.*om * tau * fracnu /
                        (4.*fracnu + 15.)); /* small diff wrt camb */

            eta = ppr->entropy_ini * fracnu * k * tau * (-1. / (4.*fracnu + 5.) +
                    (-3. / 64.*fracb / fracg + 15. / 4. / (4.*fracnu + 15.) /
                     (4.*fracnu + 5.) * om *
                     tau)); /* small diff wrt camb */
        ...
        if(ppt->gauge == newtonian)
        {
            ...
            */
            ...
            delta_tot = (fracg * ppw->pv->y[ppw->pv->index_pt_delta_g] + fracnu * delta_ur +
                         rho_m_over_rho_r * (fracb * ppw->pv->y[ppw->pv->index_pt_delta_b] + fraccdm *
                                             delta_cdm)) /
                        (1. + rho_m_over_rho_r);
            ...
            if(pba->has_idm_dr == _TRUE_)
            {
                delta_tot += rho_m_over_rho_r * fracidm_dr *
                             ppw->pv->y[ppw->pv->index_pt_delta_idm_dr] /
                             (1. + rho_m_over_rho_r);
                velocity_tot += rho_m_over_rho_r * fracidm_dr *
                                ppw->pv->y[ppw->pv->index_pt_theta_idm_dr] /
                                (1. + rho_m_over_rho_r);
            }

            alpha = (eta + 3. / 2.*a_prime_over_a * a_prime_over_a / k / k / s2_squared *
                     (delta_tot + 3.*a_prime_over_a / k / k * velocity_tot)) / a_prime_over_a;
            ...
            if(pba->has_dcdm == _TRUE_)
            {
                ppw->pv->y[ppw->pv->index_pt_delta_dcdm] -= (3.*a_prime_over_a + a *
                        pba->Gamma_dcdm) * alpha;
            ...
            if(pba->has_ndescf == _TRUE_)
            {
                ...
                for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
                {
                    ...
                    {
                        // delta_phi
                        ppw->pv->y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf] += alpha *
                                ppw->pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf];
                        // delta_phi_prime
                        ppw->pv->y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf] +=
                            (-2.*a_prime_over_a * alpha * ppw->pvecback[pba->index_bg_phi_prime_ndescf1 +
                                                                    n_ndescf]
                             - a * a * dV_ndescf(pba, ppw->pvecback[pba->index_bg_phi_ndescf1 + n_ndescf],
                                                 n_ndescf) * alpha
                             + ppw->pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf] * alpha_prime);
                    }
                    else
                    {
                        w_fld = pba->ndescf_w_fld[n_ndescf];
                        // delta
                        ppw->pv->y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf] -= 3 *
                                (1. + w_fld) * a_prime_over_a * alpha;
                        // big_theta
                        ppw->pv->y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf] += (1. + w_fld) * k * k *
                                alpha;
                    }
                }
            }
            ...
            if((pba->has_fld == _TRUE_) && (pba->use_ppf == _FALSE_))
            {
                ...
                ppw->pv->y[ppw->pv->index_pt_delta_fld] -= 3 * (1. + w_fld) * a_prime_over_a *
                        alpha;
            ...
            if(pba->has_scf == _TRUE_)
            {
                ...
                ppw->pv->y[ppw->pv->index_pt_phi_scf] += alpha *
                    ...
                    || (pba->has_idr == _TRUE_))
            {
                ...
                if(pba->has_dr == _TRUE_)
                    delta_dr += (-4.*a_prime_over_a + a * pba->Gamma_dcdm *
                                 ppw->pvecback[pba->index_bg_rho_dcdm] /
                                 ppw->pvecback[pba->index_bg_rho_dr]) * alpha;
        ...
        if(pba->has_ncdm == _TRUE_)
        {
            ...
            for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
            {
                ...
                for(index_q = 0; index_q < ppw->pv->q_size_ncdm[n_ncdm]; index_q++)
                {
                    ...
                    ppw->pv->y[idx + 1] =  -epsilon / 3. / q / k * theta_ur *
    ...
    if(_tensors_)
    {
        ...
        if(pba->sgnK != 0)
        {
            ppw->pv->y[ppw->pv->index_pt_gw] *= sqrt(k2 * (k2 - pba->K) /
                                                (k2 + 3.*pba->K) / (k2 + 2.*pba->K));
        }
        ...
        if(pba->sgnK == -1)
        {
            if(k * k + 3 * pba->K >= 0.)
            {
                ppw->pv->y[ppw->pv->index_pt_gw] *= sqrt(tanh(_PI_ / 2.*sqrt(
                                                        k2 + 3 * pba->K) / sqrt(-pba->K)));
            }
            else
            {
...
)
{
    ...
    class_call(background_at_tau(pba, tau, normal_info, ppw->inter_mode,
                                 &(ppw->last_index_back),
                                 ppw->pvecback),
               pba->error_message,
               ppt->error_message);
    ...
    if(_scalars_)
    {
        ...
        if(pba->has_idm_dr == _TRUE_)
        {
            ...
            else
            {
                ...
                if((1. / tau_h / ppw->pvecthermo[pth->index_th_dmu_idm_dr] <
                        ppr->idm_dr_tight_coupling_trigger_tau_c_over_tau_h) &&
                        (1. / tau_k / ppw->pvecthermo[pth->index_th_dmu_idm_dr] <
        ...
        /* ndescf fluid approximation by Gen Ye */
        if(pba->has_ndescf == _TRUE_)
        {
            for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
            {
                if(tau > pba->ndescf_tau_fld[n_ndescf])
                {
                    ppw->approx[ppw->index_ap_fa_ndescf1 + n_ndescf] = (int)fa_ndescf_on;
                }
                else
                {
                    ppw->approx[ppw->index_ap_fa_ndescf1 + n_ndescf] = (int)fa_ndescf_off;
                }
            }
        }
...
)
{
    ...
    /* (c) time scale of recombination, \f$ \tau_{\gamma} = 1/\kappa' \f$ */
    double tau_c;
    /* (d) time scale of ndescf oscillation \f$ \tau_k = 2*pi/a/m_ndescf \f$ by Gen Ye */
    double tau_ndescf;
    int n_ndescf, sorted_n_ndescf; // ndescf index by Gen Ye
        ...
        *timescale = tau_h;
        ...
        if(pba->has_ndescf == _TRUE_)
        {
            for(n_ndescf=0;n_ndescf<pba->N_ndescf;n_ndescf++)
            {
                ...
                if(ppw->approx[ppw->index_ap_fa_ndescf1 + sorted_n_ndescf] == (int)fa_ndescf_off)
                {
                    tau_ndescf = MIN(1. / pvecback[pba->index_bg_a] / pba->ndescf_m_fld[sorted_n_ndescf], tau_k);

                    *timescale = MIN(tau_ndescf, *timescale);
                }
            }
        }
...
)
{
    ...
    class_call(perturbations_total_stress_energy(ppr, pba, pth, ppt, index_md, k, y,
               ppw),
               ppt->error_message,
               ppt->error_message);
    ...
    if(_scalars_)
    {
        ...
        if(ppt->gauge == newtonian)
        {
            ...
            /* equation for psi */
            ppw->pvecmetric[ppw->index_mt_psi] = y[ppw->pv->index_pt_phi] - 4.5 *
                                                 (a2 / k2) * ppw->rho_plus_p_shear;
            ...
            if(ppw->approx[ppw->index_ap_rsa] == (int)rsa_on)
            {
                ...
                class_call(perturbations_rsa_delta_and_theta(ppr, pba, pth, ppt, k, y,
                           a_prime_over_a,
                           ppw->pvecthermo, ppw, ppt->error_message),
                           ppt->error_message,
                           ppt->error_message);
            }
            ...
            if((pba->has_idr) && (ppw->approx[ppw->index_ap_rsa_idr] == (int)rsa_idr_on))
            {
                ...
                class_call(perturbations_rsa_idr_delta_and_theta(ppr, pba, pth, ppt, k, y,
                           a_prime_over_a,
                           ppw->pvecthermo, ppw, ppt->error_message),
                           ppt->error_message,
                           ppt->error_message);
        ...
        if(ppt->gauge == synchronous)
        {
                    ...
                    && (ppw->approx[ppw->index_ap_rsa_idr] == (int)rsa_idr_on))
            {
                ...
                ppw->rho_plus_p_theta += 4. / 3.*ppw->pvecback[pba->index_bg_rho_idr] *
                                         ppw->rsa_theta_idr;
            ...
            ppw->pvecmetric[ppw->index_mt_eta_prime] = (1.5 * a2 * ppw->rho_plus_p_theta +
                    0.5 * pba->K *
                    ppw->pvecmetric[ppw->index_mt_h_prime]) / k2 / s2_squared; /* eta' */
            ...
            if(ppw->approx[ppw->index_ap_tca] == (int)tca_on)
            {
                ...
                shear_g = 16. / 45. / ppw->pvecthermo[pth->index_th_dkappa] *
                          (y[ppw->pv->index_pt_theta_g] + k2 *
                    ...
                    && (ppw->approx[ppw->index_ap_tca_idm_dr] == (int)tca_idm_dr_on))
            {
                ...
                shear_idr = 0.5 * 8. / 15. / ppw->pvecthermo[pth->index_th_dmu_idm_dr] /
                            ppt->alpha_idm_dr[0] *
                            (y[ppw->pv->index_pt_theta_idr] + k2 * ppw->pvecmetric[ppw->index_mt_alpha]);

                ppw->rho_plus_p_shear += 4. / 3.*ppw->pvecback[pba->index_bg_rho_idr] *
                                         shear_idr;
            }
        ...
        {
            ppw->delta_m += 3. *ppw->pvecback[pba->index_bg_a] *
                            ppw->pvecback[pba->index_bg_H] * ppw->theta_m /
                            k2;
        ...
        {
            ppw->delta_cb += 3. *ppw->pvecback[pba->index_bg_a] *
                             ppw->pvecback[pba->index_bg_H] * ppw->theta_cb
        ...
        if(ppt->has_source_theta_cb == _TRUE_)
        {
            if(ppt->gauge == synchronous)
            {
                ppw->theta_cb += ppw->pvecmetric[ppw->index_mt_alpha] *
                                 k2; //check gauge transformation
            }
        }
    }
    ...
    if(_vectors_)
    {
        ...
        if(ppt->gauge == newtonian)
        {
            ...
            ppw->pvecmetric[ppw->index_mt_V_prime] = -2.*a_prime_over_a *
                    y[ppw->pv->index_pt_V] -
        ...
        if(ppt->gauge == synchronous)
        {
            ...
            // from Hu and White:
            ppw->pvecmetric[ppw->index_mt_hv_prime_prime] = -2.*a_prime_over_a *
                    y[ppw->pv->index_pt_hv_prime] -
                    3.*ppw->vector_source_pi / k2;
    ...
    if(_tensors_)
    {
        ...
        ppw->pvecmetric[ppw->index_mt_gw_prime_prime] = -2.*a_prime_over_a *
                ...
                (k2 + 2.*pba->K) * y[ppw->pv->index_pt_gw] + ppw->gw_source;
...
)
{
    ...
    int n_ndescf;
    double delta_rho_ndescf, delta_p_ndescf, rho_plus_p_theta_ndescf, cs2_ndescf,
           ma; // for ndescf by Gen Ye
    double w_fld, dw_over_da_fld, integral_fld;
    double gwncdm;
    double rho_relativistic;
    double rho_dr_over_f;
    double delta_rho_scf, delta_p_scf, psi = 0.;
    ...
    double Gamma_fld, S, S_prime, theta_t, theta_t_prime,
           rho_plus_p_theta_fld_prime;
    ...
    if(_scalars_)
    {
        ...
        if(pba->has_ur == _TRUE_)
        {
            ...
            else
            {
                ...
                delta_ur =
                    0.; /* actual free streaming approximation imposed after evaluation of 1st einstein equation */
                theta_ur =
                    0.; /* actual free streaming approximation imposed after evaluation of 1st einstein equation */
        ...
        if((ppt->has_perturbed_recombination == _TRUE_)
                && (ppw->approx[ppw->index_ap_tca] == (int)tca_off))
        {
            delta_p_b_over_rho_b = ppw->pvecthermo[pth->index_th_wb] *
                                   (y[ppw->pv->index_pt_delta_b] +
                                    y[ppw->pv->index_pt_perturbed_recombination_delta_temp]);
        }
        else
        {
            delta_p_b_over_rho_b = ppw->pvecthermo[pth->index_th_cb2] *
                                   y[ppw->pv->index_pt_delta_b];
        }
                ...
                if(ppt->idr_nature == idr_free_streaming)
                {
                            ...
                            && (ppw->approx[ppw->index_ap_tca_idm_dr] == (int)tca_idm_dr_on))
                    {
                        if(ppt->gauge == newtonian)
                            shear_idr = 0.5 * (8. / 15. / ppw->pvecthermo[pth->index_th_dmu_idm_dr] /
                                               ppt->alpha_idm_dr[0] *
                                               (y[ppw->pv->index_pt_theta_idr]));
                        else
                            shear_idr =
                                0.; /* this is set in perturbations_einstein, so here it's set to 0 */
                    }
                    else
                    {
        ...
        ppw->delta_rho = ppw->pvecback[pba->index_bg_rho_g] * delta_g
                         ...
                         y[ppw->pv->index_pt_delta_b]; // contribution to total perturbed stress-energy
        ppw->rho_plus_p_theta = 4. / 3.*ppw->pvecback[pba->index_bg_rho_g] * theta_g
                                + ppw->pvecback[pba->index_bg_rho_b] *
                                y[ppw->pv->index_pt_theta_b]; // contribution to total perturbed stress-energy
        ppw->rho_plus_p_shear = 4. / 3.*ppw->pvecback[pba->index_bg_rho_g] *
                                shear_g; // contribution to total perturbed stress-energy
        ppw->delta_p = 1. / 3.*ppw->pvecback[pba->index_bg_rho_g] * delta_g
                       + ppw->pvecback[pba->index_bg_rho_b] *
                       delta_p_b_over_rho_b; // contribution to total perturbed stress-energy
        ppw->rho_plus_p_tot = 4. / 3. * ppw->pvecback[pba->index_bg_rho_g] +
                              ppw->pvecback[pba->index_bg_rho_b];

        if(ppt->has_source_delta_m == _TRUE_)
        {
            delta_rho_m = ppw->pvecback[pba->index_bg_rho_b] *
                          y[ppw->pv->index_pt_delta_b]; // contribution to delta rho_matter
            rho_m = ppw->pvecback[pba->index_bg_rho_b];
        }
        if((ppt->has_source_delta_m == _TRUE_) || (ppt->has_source_theta_m == _TRUE_))
        {
            rho_plus_p_theta_m = ppw->pvecback[pba->index_bg_rho_b] *
                                 y[ppw->pv->index_pt_theta_b]; // contribution to [(rho+p)theta]_matter
        ...
        if(pba->has_cdm == _TRUE_)
        {
            ppw->delta_rho += ppw->pvecback[pba->index_bg_rho_cdm] *
                              y[ppw->pv->index_pt_delta_cdm]; // contribution to total perturbed stress-energy
            if(ppt->gauge == newtonian)
                ppw->rho_plus_p_theta = ppw->rho_plus_p_theta +
                                        ppw->pvecback[pba->index_bg_rho_cdm] *
                                        y[ppw->pv->index_pt_theta_cdm]; // contribution to total perturbed stress-energy

            ppw->rho_plus_p_tot += ppw->pvecback[pba->index_bg_rho_cdm];

            if(ppt->has_source_delta_m == _TRUE_)
            {
                delta_rho_m += ppw->pvecback[pba->index_bg_rho_cdm] *
                               y[ppw->pv->index_pt_delta_cdm]; // contribution to delta rho_matter
                rho_m += ppw->pvecback[pba->index_bg_rho_cdm];
            }
            if((ppt->has_source_delta_m == _TRUE_) || (ppt->has_source_theta_m == _TRUE_))
            {
                if(ppt->gauge == newtonian)
                    rho_plus_p_theta_m += ppw->pvecback[pba->index_bg_rho_cdm] *
                                          y[ppw->pv->index_pt_theta_cdm]; // contribution to [(rho+p)theta]_matter
        ...
        if(pba->has_idm_dr == _TRUE_)
        {
            ppw->delta_rho += ppw->pvecback[pba->index_bg_rho_idm_dr] *
                              y[ppw->pv->index_pt_delta_idm_dr];
            ppw->rho_plus_p_theta += ppw->pvecback[pba->index_bg_rho_idm_dr] *
                                     y[ppw->pv->index_pt_theta_idm_dr];
            ppw->rho_plus_p_tot += ppw->pvecback[pba->index_bg_rho_idm_dr];
            if(ppt->has_source_delta_m == _TRUE_)
            {
                delta_rho_m += ppw->pvecback[pba->index_bg_rho_idm_dr] *
                               y[ppw->pv->index_pt_delta_idm_dr]; // contribution to delta rho_matter
                rho_m += ppw->pvecback[pba->index_bg_rho_idm_dr];
            }
            if((ppt->has_source_delta_m == _TRUE_) || (ppt->has_source_theta_m == _TRUE_))
            {
                if(ppt->gauge == newtonian)
                    rho_plus_p_theta_m += ppw->pvecback[pba->index_bg_rho_idm_dr] *
                                          y[ppw->pv->index_pt_theta_idm_dr]; // contribution to [(rho+p)theta]_matter
        ...
        if(pba->has_dcdm == _TRUE_)
        {
            ...
            if(ppt->has_source_delta_m == _TRUE_)
            {
                delta_rho_m += ppw->pvecback[pba->index_bg_rho_dcdm] *
                               y[ppw->pv->index_pt_delta_dcdm]; // contribution to delta rho_matter
                rho_m += ppw->pvecback[pba->index_bg_rho_dcdm];
            }
            if((ppt->has_source_delta_m == _TRUE_) || (ppt->has_source_theta_m == _TRUE_))
            {
                rho_plus_p_theta_m += ppw->pvecback[pba->index_bg_rho_dcdm] *
                                      y[ppw->pv->index_pt_theta_dcdm]; // contribution to [(rho+p)theta]_matter
        ...
        if(pba->has_dr == _TRUE_)
        {
            ...
            */
            ...
            ppw->rho_plus_p_theta += 4. / 3.*3. / 4 * k * rho_dr_over_f *
                                     y[ppw->pv->index_pt_F0_dr + 1];
        ...
        if(pba->has_ur == _TRUE_)
        {
            ppw->delta_rho = ppw->delta_rho + ppw->pvecback[pba->index_bg_rho_ur] *
                             delta_ur;
            ppw->rho_plus_p_theta = ppw->rho_plus_p_theta + 4. /
                                    3.*ppw->pvecback[pba->index_bg_rho_ur] *
                                    theta_ur;
            ppw->rho_plus_p_shear = ppw->rho_plus_p_shear + 4. /
                                    3.*ppw->pvecback[pba->index_bg_rho_ur] *
                                    shear_ur;
        ...
        if(pba->has_ncdm == _TRUE_)
        {
            ...
            if(ppw->approx[ppw->index_ap_ncdmfa] == (int)ncdmfa_on)
            {
                ...
                for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
                {
                    ...
                    cg2_ncdm = w_ncdm * (1.0 - 1.0 / (3.0 + 3.0 * w_ncdm) *
                                         (3.0 * w_ncdm - 2.0 + pseudo_p_ncdm /
                                          p_ncdm_bg));
            ...
            else
            {
                ...
                for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
                {
                    ...
                    if((ppt->has_source_delta_ncdm == _TRUE_)
                            ...
                            || (ppt->has_source_delta_m == _TRUE_))
                    {
                        ppw->delta_ncdm[n_ncdm] = rho_delta_ncdm / ppw->pvecback[pba->index_bg_rho_ncdm1
                                                  + n_ncdm];
                    ...
                    ppw->rho_plus_p_tot += ppw->pvecback[pba->index_bg_rho_ncdm1 + n_ncdm] +
                                           ppw->pvecback[pba->index_bg_p_ncdm1 + n_ncdm];
                }
            }
            if(ppt->has_source_delta_m == _TRUE_)
            {
                for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
                {
                    delta_rho_m += ppw->pvecback[pba->index_bg_rho_ncdm1 + n_ncdm] *
                                   ppw->delta_ncdm[n_ncdm]; // contribution to delta rho_matter
            ...
            if((ppt->has_source_delta_m == _TRUE_) || (ppt->has_source_theta_m == _TRUE_))
            {
                for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
                {
                    rho_plus_p_theta_m += (ppw->pvecback[pba->index_bg_rho_ncdm1 + n_ncdm] +
                                           ppw->pvecback[pba->index_bg_p_ncdm1 + n_ncdm])
                                          * ppw->theta_ncdm[n_ncdm]; // contribution to [(rho+p)theta]_matter
                    rho_plus_p_m += (ppw->pvecback[pba->index_bg_rho_ncdm1 + n_ncdm] +
                                     ppw->pvecback[pba->index_bg_p_ncdm1 + n_ncdm]);
                }
            }
        }
        ...
        */
        if(pba->has_scf == _TRUE_)
        {
            ...
            if(ppt->gauge == newtonian)
            {
                ...
                delta_rho_scf -= 1. / 3. / a2 * pow(ppw->pvecback[pba->index_bg_phi_prime_scf],
                                                    2) * psi;
                delta_p_scf -= 1. / 3. / a2 * pow(ppw->pvecback[pba->index_bg_phi_prime_scf],
                                                  2) * psi;
            }
            ...
            ppw->rho_plus_p_tot += ppw->pvecback[pba->index_bg_rho_scf] +
                                   ppw->pvecback[pba->index_bg_p_scf];
        ...
        if(pba->has_ndescf == _TRUE_)
        {
            ...
            for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
            {
                if(ppw->approx[ppw->index_ap_fa_ndescf1 + n_ndescf] == (int)fa_ndescf_on)
                {
                    // recall x1=delta x2=big_theta=(1+w_fld)*theta
                    w_fld = pba->ndescf_w_fld[n_ndescf];
                    // rest frame sound speed depends on potential, currently only axion is supported
                    if(pba->ndescf_parameters[(n_ndescf + 1) * pba->ndescf_parameters_size - 3] < 0)
                    {
                        ma = pba->ndescf_parameters[n_ndescf * pba->ndescf_parameters_size + 1];
                        cs2_ndescf = k2 / (4 * ma * ma * a2) / (1 + k2 / (4 * ma * ma * a2));
                    }
                    delta_rho_ndescf = ppw->pvecback[pba->index_bg_rho_ndescf1 + n_ndescf] *
                                       y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf];
                    rho_plus_p_theta_ndescf = ppw->pvecback[pba->index_bg_rho_ndescf1 + n_ndescf] *
                                              y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf];
                    /* from rest frame to current gauge, ca2_fld = w_fld is constant in our case */
                    delta_p_ndescf = cs2_ndescf * delta_rho_ndescf + (cs2_ndescf - w_fld) *
                                     (3 * a_prime_over_a * rho_plus_p_theta_ndescf / k / k);
                }
                else
                {
                    // recall x1=phi x2=phi_prime
                    delta_rho_ndescf =  1. / 3.*(1. / a2 *
                                                 ppw->pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf] *
                                                 y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf] +
                                                 ppw->pvecback[pba->index_bg_dV_ndescf1 + n_ndescf] *
                                                 y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf]);
                    delta_p_ndescf  = 1. / 3.*(1. / a2 *
                                               ppw->pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf] *
                                               y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf] -
                                               ppw->pvecback[pba->index_bg_dV_ndescf1 + n_ndescf] *
                                               y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf]);
                    if(ppt->gauge == newtonian)
                    {
                        delta_rho_ndescf -= 1. / 3. / a2 * pow(
                                                ppw->pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf],
                                                2) * psi;
                        delta_p_ndescf -= 1. / 3. / a2 * pow(
                                              ppw->pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf],
                                              2) * psi;
                    }
                    rho_plus_p_theta_ndescf = 1. / 3.*k * k / a2 *
                                              ppw->pvecback[pba->index_bg_phi_prime_ndescf1 +
                                                            n_ndescf] * y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf];
                }
                // w=0 fluid regarded as dark matter
                if(pba->ndescf_w_fld[n_ndescf] == 0.)
                {
                    // ndescf does not behave like dark matter at and before the time of thawing
                    // do we still want to include it in delta_m?
                    // if only include it when fld approx is on, then how to do it in a continuous way?
                    if(ppt->has_source_delta_m == _TRUE_)
                    {
                        delta_rho_m += delta_rho_ndescf; // contribution to delta rho_matter
                        rho_m += ppw->pvecback[pba->index_bg_rho_ndescf1 + n_ndescf];
                    }
                    if((ppt->has_source_delta_m == _TRUE_) || (ppt->has_source_theta_m == _TRUE_))
                    {
                        rho_plus_p_theta_m +=
                            rho_plus_p_theta_ndescf; // contribution to [(rho+p)theta]_matter
                        rho_plus_p_m += ppw->pvecback[pba->index_bg_rho_ndescf1 + n_ndescf] +
                                        ppw->pvecback[pba->index_bg_p_ndescf1 + n_ndescf];
                    }
                }
                ppw->delta_rho += delta_rho_ndescf;
                ppw->delta_p += delta_p_ndescf;
                ppw->rho_plus_p_theta += rho_plus_p_theta_ndescf;
                ppw->rho_plus_p_tot += ppw->pvecback[pba->index_bg_rho_ndescf1 + n_ndescf] +
                                       ppw->pvecback[pba->index_bg_p_ndescf1 + n_ndescf];
        ...
        if(pba->has_fld == _TRUE_)
        {
            ...
            if(pba->use_ppf == _FALSE_)
            {
                ppw->delta_rho_fld = ppw->pvecback[pba->index_bg_rho_fld] *
                                     y[ppw->pv->index_pt_delta_fld];
                ppw->rho_plus_p_theta_fld = (1. + w_fld) * ppw->pvecback[pba->index_bg_rho_fld]
                                            *
                ...
                ppw->delta_p_fld = pba->cs2_fld * ppw->delta_rho_fld + (pba->cs2_fld - ca2_fld)
                                   *
            ...
            else
            {
                ...
                c_gamma_k_H_square = pow(pba->c_gamma_over_c_fld * k / a_prime_over_a,
                                         2) * pba->cs2_fld;
                ...
                */
                ...
                if(ppt->gauge == synchronous)
                {
                    alpha = (y[ppw->pv->index_pt_eta] + 1.5 * a2 / k2 / s2sq *
                             (ppw->delta_rho + 3 * a_prime_over_a / k2
                              * ppw->rho_plus_p_theta) - Gamma_fld) / a_prime_over_a;
                    alpha_prime = -2. * a_prime_over_a * alpha + y[ppw->pv->index_pt_eta] - 4.5 *
                                  (a2 / k2) * ppw->rho_plus_p_shear;
                    metric_euler = 0.;
                }
                else
                ...
                ppw->S_fld = ppw->pvecback[pba->index_bg_rho_fld] * (1. + w_fld) * 1.5 * a2 /
                             k2 / a_prime_over_a *
                ...
                Gamma_prime_plus_a_prime_over_a_Gamma = ppw->Gamma_prime_fld + a_prime_over_a *
                                                        Gamma_fld;
                // delta and theta in both gauges gauge:
                ppw->rho_plus_p_theta_fld = ppw->pvecback[pba->index_bg_rho_fld] *
                                            (1. + w_fld) *
                                            ppw->rho_plus_p_theta / ppw->rho_plus_p_tot -
                                            k2 * 2. / 3.*a_prime_over_a / a2 / (1 + 4.5 * a2 / k2 / s2sq *
                                                    ppw->rho_plus_p_tot) *
                                            (ppw->S_fld - Gamma_prime_plus_a_prime_over_a_Gamma / a_prime_over_a);
                ppw->delta_rho_fld = -2. / 3.*k2 * s2sq / a2 * Gamma_fld - 3 * a_prime_over_a /
                                     k2 *
                ...
                X_prime = -2 * X * (a_prime_over_a + ppw->pvecback[pba->index_bg_H_prime] /
                                    ppw->pvecback[pba->index_bg_H]);
                ...
                Z_prime = Z * (ppw->pvecback[pba->index_bg_H_prime] /
                               ppw->pvecback[pba->index_bg_H] -
                               a_prime_over_a);
                /** Construct theta_t and its derivative from the Euler equation */
                theta_t = ppw->rho_plus_p_theta / ppw->rho_plus_p_tot;
                theta_t_prime = -a_prime_over_a * theta_t - (p_t_prime * theta_t - k2 *
                                ppw->delta_p + k2 *
                                ppw->rho_plus_p_shear) / ppw->rho_plus_p_tot + metric_euler;
                S = ppw->S_fld;
                S_prime = -Z_prime / Z * S + 1. / Z * (rho_fld_prime + p_fld_prime) *
                          (theta_t + k2 * alpha) + 1. / Z * (rho_fld + p_fld) * (theta_t_prime + k2 *
                                  alpha_prime);
                /** Analytic derivative of the equation for ppw->rho_plus_p_theta_fld above. */
                rho_plus_p_theta_fld_prime = Z_prime * (S - 1. / (1. + Y) * (S /
                                                        (1. + 1. / X) + Gamma_fld * X)) +
                                             Z * (S_prime + Y_prime / (1. + Y * Y + 2 * Y) * (S / (1. + 1. / X) + Gamma_fld *
                                                     X) -
                                                  1. / (1. + Y) * (S_prime / (1. + 1. / X) + S * X_prime /
                                                          (1. + X * X + 2 * X) + ppw->Gamma_prime_fld
                                                          * X + Gamma_fld * X_prime)) -
                                             k2 * alpha_prime * (rho_fld + p_fld) - k2 * alpha * (rho_fld_prime +
                                                     p_fld_prime);

                /** We can finally compute the pressure perturbation using the Euler equation for theta_fld */
                ppw->delta_p_fld = (rho_plus_p_theta_fld_prime + 4 * a_prime_over_a *
                                    ppw->rho_plus_p_theta_fld -
                                    (rho_fld + p_fld) * metric_euler) / k2;
            }
        ...
        if(ppt->evolve_tensor_ncdm == _TRUE_)
        {
            ...
            for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
            {
                ...
                for(index_q = 0; index_q < ppw->pv->q_size_ncdm[n_ncdm]; index_q ++)
                {
                    ...
                    gwncdm += q2 * q2 / epsilon * pba->w_ncdm[n_ncdm][index_q] *
                              (1. / 15.*y[idx] + 2. / 21.*y[idx + 2]
                               + 1. / 35.*y[idx + 4]);
...
)
{
    ...
    a_prime_over_a = pvecback[pba->index_bg_a] *
                     pvecback[pba->index_bg_H]; /* (a'/a)=aH */
    a_prime_over_a_prime = pvecback[pba->index_bg_H_prime] *
                           pvecback[pba->index_bg_a] + pow(
                               pvecback[pba->index_bg_H] * pvecback[pba->index_bg_a],
                               2); /* (a'/a)' = aH'+(aH)^2 */
    ...
    if(_scalars_)
    {
        ...
        else
        {
            ...
            if(ppw->approx[ppw->index_ap_tca] == (int)tca_on)
                ...
                P = (y[ppw->pv->index_pt_pol0_g] + y[ppw->pv->index_pt_pol2_g] + 2.* ppw->s_l[2]
                     *
                     y[ppw->pv->index_pt_shear_g]) / 8.;
            ...
            */
            ...
            if(ppt->gauge == newtonian)
            {
                _set_source_(ppt->index_tp_t0) =
                    ppt->switch_sw * pvecthermo[pth->index_th_g] * (delta_g / 4. +
                            pvecmetric[ppw->index_mt_psi])
                    + switch_isw * (pvecthermo[pth->index_th_g] * (y[ppw->pv->index_pt_phi] -
                                    pvecmetric[ppw->index_mt_psi])
                                    + pvecthermo[pth->index_th_exp_m_kappa] * 2. *
                                    pvecmetric[ppw->index_mt_phi_prime])
                    + ppt->switch_dop / k / k * (pvecthermo[pth->index_th_g] *
                                                 dy[ppw->pv->index_pt_theta_b]
                                                 + pvecthermo[pth->index_th_dg] * y[ppw->pv->index_pt_theta_b]);

                _set_source_(ppt->index_tp_t1) = switch_isw *
                                                 pvecthermo[pth->index_th_exp_m_kappa] * k *
                                                 (pvecmetric[ppw->index_mt_psi] - y[ppw->pv->index_pt_phi]);

                _set_source_(ppt->index_tp_t2) = ppt->switch_pol * pvecthermo[pth->index_th_g] *
                                                 P;
            }
            ...
            */
            ...
            if(ppt->gauge == synchronous)
            {
                ...
                _set_source_(ppt->index_tp_t0) =
                    ...
                    + ppt->switch_dop * (pvecthermo[pth->index_th_g] *
                                         (dy[ppw->pv->index_pt_theta_b] / k / k +
                                          pvecmetric[ppw->index_mt_alpha_prime])
                                         + pvecthermo[pth->index_th_dg] * (y[ppw->pv->index_pt_theta_b] / k / k +
                                                 pvecmetric[ppw->index_mt_alpha]));

                _set_source_(ppt->index_tp_t1) =
                    switch_isw * pvecthermo[pth->index_th_exp_m_kappa] * k *
                    (pvecmetric[ppw->index_mt_alpha_prime]
                     + 2. * a_prime_over_a * pvecmetric[ppw->index_mt_alpha]
                     - y[ppw->pv->index_pt_eta]);
                ...
                || (ppt->has_source_k2gamma_Nb == _TRUE_))
        {
            ...
            H_T_Nb_prime = 3 * a_prime_over_a / ppw->rho_plus_p_tot * (-ppw->delta_p +
                           pvecback[pba->index_bg_p_tot_prime] * ppw->rho_plus_p_theta /
                           ppw->rho_plus_p_tot / k / k +
            ...
            {
                _set_source_(ppt->index_tp_k2gamma_Nb) = -a_prime_over_a * H_T_Nb_prime + 9. /
                        2.*a2 *
                        ppw->rho_plus_p_shear;
            }
        }
        ...
        if(ppt->has_source_phi == _TRUE_)
        {
            ...
            if(ppt->gauge == synchronous)
                _set_source_(ppt->index_tp_phi) = y[ppw->pv->index_pt_eta] - a_prime_over_a *
                                                  pvecmetric[ppw->index_mt_alpha];
        ...
        if(ppt->has_Nbody_gauge_transfers == _TRUE_)
        {
            ...
            if(ppt->gauge == synchronous) theta_shift += pvecmetric[ppw->index_mt_alpha] * k
                        * k;
        }
        else
        {
        ...
        if(ppt->has_source_delta_tot == _TRUE_)
        {
            ...
            _set_source_(ppt->index_tp_delta_tot) = ppw->delta_rho / rho_tot
                                                    + 3 * a_prime_over_a * (1 + pvecback[pba->index_bg_p_tot] /
        ...
        if(ppt->has_source_delta_dcdm == _TRUE_)
        {
            _set_source_(ppt->index_tp_delta_dcdm) = y[ppw->pv->index_pt_delta_dcdm]
                    + (3.*a_prime_over_a + a * pba->Gamma_dcdm) *
                    theta_over_k2; // N-body gauge correction;
        }

        /* delta_fld */
        if(ppt->has_source_delta_fld == _TRUE_)
        {
            _set_source_(ppt->index_tp_delta_fld) = ppw->delta_rho_fld /
                                                    pvecback[pba->index_bg_rho_fld]
                                                    + 3.*a_prime_over_a * (1. + pvecback[pba->index_bg_w_fld]) *
                                                    theta_over_k2; // N-body gauge correction
        }

        /* delta_ndescf by Gen Ye*/
        if(ppt->has_source_delta_ndescf == _TRUE_)
        {
            for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
            {
                index_tp = ppt->index_tp_delta_ndescf1 + n_ndescf;
                if(ppw->approx[ppw->index_ap_fa_ndescf1 + n_ndescf] == (int)fa_ndescf_on)
                {
                    // recall x1=delta
                    _set_source_(index_tp) = y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf] +
                                             3.*a_prime_over_a *
                                             (1. + pba->ndescf_w_fld[n_ndescf]) *
                                             theta_over_k2; // N-body gauge correction
                }
                else
                {
                    // recall x1=phi x2=phi_prime
                    delta_rho_scf =  1. / 3.*
                                     (1. / a2 * ppw->pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf] *
                                      y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf]
                                      + ppw->pvecback[pba->index_bg_dV_ndescf1 + n_ndescf] *
                                      y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf]);
                    if(ppt->gauge == newtonian)
                    {
                        delta_rho_scf -=  1. / 3. / a2 * pow(
                                              ppw->pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf],
                                              2) * ppw->pvecmetric[ppw->index_mt_psi];
                    }
                    _set_source_(index_tp) = delta_rho_scf / pvecback[pba->index_bg_rho_ndescf1 +
                                                                       n_ndescf] +
                                             3.*a_prime_over_a * (1. + pvecback[pba->index_bg_p_ndescf1 + n_ndescf] /
                                                     pvecback[pba->index_bg_rho_ndescf1 + n_ndescf]) *
                                             theta_over_k2; // N-body gauge correction, is it the correct place? by Gen Ye
                }
            }
        }
            ...
            else
            {
                delta_rho_scf =  1. / 3.*
                                 (1. / a2 * ppw->pvecback[pba->index_bg_phi_prime_scf] *
                                  y[ppw->pv->index_pt_phi_prime_scf]
                                  + ppw->pvecback[pba->index_bg_dV_scf] * y[ppw->pv->index_pt_phi_scf]
                                  - 1. / a2 * pow(ppw->pvecback[pba->index_bg_phi_prime_scf],
                                                  2) * ppw->pvecmetric[ppw->index_mt_psi]);
            }
            _set_source_(ppt->index_tp_delta_scf) = delta_rho_scf /
                                                    pvecback[pba->index_bg_rho_scf] +
                                                    3.*a_prime_over_a * (1. + pvecback[pba->index_bg_p_scf] /
                                                            pvecback[pba->index_bg_rho_scf]) *
                                                    theta_over_k2; // N-body gauge correction. should be here? by Gen Ye;
        }
        ...
        if(ppt->has_source_delta_ncdm == _TRUE_)
        {
            for(index_tp = ppt->index_tp_delta_ncdm1;
                    index_tp < ppt->index_tp_delta_ncdm1 + pba->N_ncdm;
                    index_tp++)
            {
                _set_source_(index_tp) = ppw->delta_ncdm[index_tp - ppt->index_tp_delta_ncdm1]
                                         + 3.*a_prime_over_a * (1 + pvecback[index_tp - ppt->index_tp_delta_ncdm1 +
                                                          pba->index_bg_p_ncdm1]
                                                 / pvecback[index_tp - ppt->index_tp_delta_ncdm1 + pba->index_bg_rho_ncdm1]) *
                                         theta_over_k2; // N-body gauge correction
            }
        }
        ...
        {
            _set_source_(ppt->index_tp_theta_tot) = ppw->rho_plus_p_theta /
                                                    (pvecback[pba->index_bg_rho_tot] +
        ...
        if(ppt->has_source_theta_fld == _TRUE_)
        {
            ...
            _set_source_(ppt->index_tp_theta_fld) = ppw->rho_plus_p_theta_fld /
                                                    (1. + w_fld) /
                                                    pvecback[pba->index_bg_rho_fld]
                                                    + theta_shift; // N-body gauge correction
        }

        /* theta_ndescf by Gen Ye*/
        if(ppt->has_source_bigtheta_ndescf == _TRUE_)
        {
            for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
            {
                index_tp = ppt->index_tp_bigtheta_ndescf1 + n_ndescf;
                if(ppw->approx[ppw->index_ap_fa_ndescf1 + n_ndescf] == (int)fa_ndescf_on)
                {
                    // recall x2=big_theta
                    w_fld = pba->ndescf_w_fld[n_ndescf];
                    _set_source_(index_tp) = y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf] +
                                             (1. + w_fld) * ppw->pvecback[pba->index_bg_rho_ndescf1 + n_ndescf] *
                                             theta_shift; // N-body gauge correction
                }
                else
                {
                    rho_plus_p_theta_scf = 1. / 3.*
                                           k * k / a2 * ppw->pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf] *
                                           y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf];

                    _set_source_(index_tp) = rho_plus_p_theta_scf +
                                             (pvecback[pba->index_bg_rho_ndescf1 + n_ndescf] +
                                              pvecback[pba->index_bg_p_ndescf1 + n_ndescf]) *
                                             theta_shift; // N-body gauge correction
                }
            }
        }
        ...
        if(ppt->has_source_theta_dr == _TRUE_)
        {
            ...
            _set_source_(ppt->index_tp_theta_dr) = 3. / 4.*k * y[ppw->pv->index_pt_F0_dr +
                                                                           1] / f_dr
                                                   + theta_shift; // N-body gauge correction
        }
        ...
        {
            for(index_tp = ppt->index_tp_theta_ncdm1;
                    index_tp < ppt->index_tp_theta_ncdm1 + pba->N_ncdm;
                    index_tp++)
            {
    ...
    if(_tensors_)
    {
        ...
        if(ppw->approx[ppw->index_ap_rsa] == (int)rsa_off)
        {
            ...
            else
            {
                P = 2. / 5.*_SQRT6_ * y[ppw->pv->index_pt_gwdot] /
                    ppw->pvecthermo[pth->index_th_dkappa]; //TBC
            }
        }
        else
        {
        ...
        if(ppt->has_source_t == _TRUE_)
        {
            _set_source_(ppt->index_tp_t2) = - y[ppw->pv->index_pt_gwdot] *
                                             pvecthermo[pth->index_th_exp_m_kappa] + pvecthermo[pth->index_th_g] * P;
        }
                                 ...
                                 )
{
    ...
    /* non dark energy scalar fields output by Gen Ye */
    int n_ndescf;
    double ma, delta_rho_ndescf, delta_p_ndescf, rho_plus_p_theta_ndescf, w_fld;
    double *delta_ndescf = NULL, *bigtheta_ndescf = NULL, *cs2_ad_ndescf = NULL,
            *cs2_eff_ndescf = NULL,
             *delta_phi_ndescf = NULL,
              *delta_phi_prime_ndescf = NULL;
    /*more scf output by Gen Ye*/
    double delta_phi_scf = 0., delta_phi_prime_scf = 0., rf_cs2_scf = 0.,
           ad_cs2_scf = 0.;
    // double delta_rho_scf=0., rho_plus_p_theta_scf=0.;
    double delta_rho_scf = 0., delta_p_scf = 0.,
           rho_plus_p_theta_scf = 0.; // added delta_p_scf
    /*end of modification by Gen Ye*/
    double delta_scf = 0., theta_scf = 0.;
    /** - ncdm sector begins */
    int n_ncdm;
    double *delta_ncdm = NULL, *theta_ncdm = NULL, *shear_ncdm = NULL,
            *delta_p_over_delta_rho_ncdm = NULL;
    ...
    if(pba->has_ncdm == _TRUE_)
    {
        ...
        class_alloc(delta_p_over_delta_rho_ncdm, sizeof(double)*pba->N_ncdm,
                    error_message);
    }

    /* allocate array of ndescf output by Gen Ye */
    if(pba->has_ndescf == _TRUE_)
    {
        class_alloc(delta_ndescf, sizeof(double)*pba->N_ndescf, error_message);
        class_alloc(bigtheta_ndescf, sizeof(double)*pba->N_ndescf, error_message);
        class_alloc(cs2_ad_ndescf, sizeof(double)*pba->N_ndescf, error_message);
        class_alloc(cs2_eff_ndescf, sizeof(double)*pba->N_ndescf, error_message);
        class_alloc(delta_phi_ndescf, sizeof(double)*pba->N_ndescf, error_message);
        class_alloc(delta_phi_prime_ndescf, sizeof(double)*pba->N_ndescf,
                    error_message);
    }
    ...
    if(_scalars_)
    {
        ...
        if(ppw->approx[ppw->index_ap_rsa] == (int)rsa_off)
        {
            if(ppw->approx[ppw->index_ap_tca] == (int)tca_on)
            {
                ...
                pol1_g = 7. / 12.*6. / 7.*k / pvecthermo[pth->index_th_dkappa] *
                         ppw->tca_shear_g;
        ...
        if(ppt->gauge == synchronous)
        {
            ...
            psi = pvecback[pba->index_bg_H] * pvecback[pba->index_bg_a] * alpha +
                  pvecmetric[ppw->index_mt_alpha_prime];
            phi = y[ppw->pv->index_pt_eta] - pvecback[pba->index_bg_H] *
                  pvecback[pba->index_bg_a] * alpha;
        }
        ...
        if(pba->has_ncdm == _TRUE_)
        {
            ...
            if(ppw->approx[ppw->index_ap_ncdmfa] == (int)ncdmfa_on)
            {
                ...
                for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
                {
                    ...
                    delta_p_over_delta_rho_ncdm[n_ncdm] = w_ncdm * (1.0 - 1.0 /
                                                          (3.0 + 3.0 * w_ncdm) *
                                                          (3.0 * w_ncdm - 2.0 + pseudo_p_ncdm / p_ncdm_bg));
                    idx += ppw->pv->l_max_ncdm[n_ncdm] + 1;
                }
            }
            else
            {
                ...
                for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
                {
                    ...
                    delta_ncdm[n_ncdm] = rho_delta_ncdm / ppw->pvecback[pba->index_bg_rho_ncdm1 +
                                         n_ncdm];
        ...
        if(pba->has_dr == _TRUE_)
        {
            f_dr = pow(pvecback[pba->index_bg_a] * pvecback[pba->index_bg_a] / pba->H0,
                       2) * pvecback[pba->index_bg_rho_dr];
        ...
        /* add non dark energy scalar fields by Gen Ye */
        if(pba->has_ndescf == _TRUE_)
        {
            for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
            {
                if(ppw->approx[ppw->index_ap_fa_ndescf1 + n_ndescf] == (int)fa_ndescf_on)
                {
                    ...
                    {
                        ma = pba->ndescf_parameters[n_ndescf * pba->ndescf_parameters_size + 1];
                        cs2_eff_ndescf[n_ndescf] = k * k / (4 * ma * ma * a2) / (1 + k * k /
                                                   (4 * ma * ma * a2));
                    }
                    delta_ndescf[n_ndescf] = y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf];
                    bigtheta_ndescf[n_ndescf] = y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf];
                    // set to zero so we know when fld approx is turned on
                    delta_phi_ndescf[n_ndescf] = 0.;
                    delta_phi_prime_ndescf[n_ndescf] = 0.;
                }
                else
                {
                    delta_rho_ndescf =  1. / 3.*
                                        (1. / a2 * pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf] *
                                         y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf]
                                         + pvecback[pba->index_bg_dV_ndescf1 + n_ndescf] *
                                         y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf]);
                    delta_p_ndescf = 1. / 3.*
                                     (1. / a2 * pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf] *
                                      y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf]
                                      - pvecback[pba->index_bg_dV_ndescf1 + n_ndescf] *
                                      y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf]);
                    rho_plus_p_theta_ndescf =  1. / 3.*
                                               k * k / a2 * pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf] *
                                               y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf];
                    delta_ndescf[n_ndescf] = delta_rho_ndescf / pvecback[pba->index_bg_rho_ndescf1 +
                                             n_ndescf];
                    bigtheta_ndescf[n_ndescf] = rho_plus_p_theta_ndescf /
                                                pvecback[pba->index_bg_rho_ndescf1 +
                                                                                   n_ndescf];
                    cs2_ad_ndescf[n_ndescf] = (-3.*a * H * pvecback[pba->index_bg_phi_prime_ndescf1
                                               + n_ndescf] - 2.*a2
                                               * pvecback[pba->index_bg_dV_ndescf1 + n_ndescf]) / (-3.*a * H *
                                                       pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf]);
                    cs2_eff_ndescf[n_ndescf] = ((delta_p_ndescf / delta_rho_ndescf) *
                                                delta_ndescf[n_ndescf] +
                                                3.*cs2_ad_ndescf[n_ndescf] * a * H * bigtheta_ndescf[n_ndescf] / (k * k)) /
                                               (delta_ndescf[n_ndescf] + 3. * a * H * bigtheta_ndescf[n_ndescf] / (k * k));
                    delta_phi_ndescf[n_ndescf] = y[ppw->pv->index_pt_x1_ndescf1 + n_ndescf];
                    delta_phi_prime_ndescf[n_ndescf] = y[ppw->pv->index_pt_x2_ndescf1 + n_ndescf];
                }
            }
        }
        ...
        if(pba->has_scf == _TRUE_)
        {
            ...
            theta_scf = rho_plus_p_theta_scf / (pvecback[pba->index_bg_rho_scf] +
                                                pvecback[pba->index_bg_p_scf]);

            /*more scf output by Gen Ye*/
            delta_phi_scf = y[ppw->pv->index_pt_phi_scf];
            delta_phi_prime_scf = y[ppw->pv->index_pt_phi_prime_scf];
            // adiabatic sound speed p_prime/rho_prime
            ad_cs2_scf = (-3.*a * H * pvecback[pba->index_bg_phi_prime_scf]
                          - 2.*a2 * pvecback[pba->index_bg_dV_scf]) / (-3.*a * H *
                                  pvecback[pba->index_bg_phi_prime_scf]);
            // rest frame sound speed
            rf_cs2_scf = ((delta_p_scf / delta_rho_scf) * delta_scf + 3.*ad_cs2_scf * (1 +
                          pvecback[pba->index_bg_p_scf] / pvecback[pba->index_bg_rho_scf]) * a * H *
                          theta_scf / (k * k)) /
                         (delta_scf
                          + 3.*(1 + pvecback[pba->index_bg_p_scf] / pvecback[pba->index_bg_rho_scf]) * a *
                          H * theta_scf /
                          (k * k));
            /*end of modification by Gen Ye*/
        }
        ...
        if(ppt->gauge == synchronous)
        {
            ...
            if(pba->has_dr == _TRUE_)
            {
                delta_dr += (-4.*a * H + a * pba->Gamma_dcdm *
                             pvecback[pba->index_bg_rho_dcdm] /
                             pvecback[pba->index_bg_rho_dr]) * alpha;
            ...
            if(pba->has_idm_dr == _TRUE_)
            {
                delta_idm_dr -= 3. * pvecback[pba->index_bg_H] * pvecback[pba->index_bg_a] *
                                alpha;
            ...
            if(pba->has_ndescf == _TRUE_)
            {
                for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
                {
                    ...
                    {
                        w_fld = pvecback[pba->index_bg_p_ndescf1 + n_ndescf] /
                                pvecback[pba->index_bg_rho_ndescf1 +
                                                                   n_ndescf];
                    }
                    delta_ndescf[n_ndescf] -= 3.0 * a * H * (1. + w_fld) * alpha;
                    bigtheta_ndescf[n_ndescf] += (1. + w_fld) * k * k * alpha;
                }
            }

            if(pba->has_scf == _TRUE_)
            {
                /*switch to using scf feild by Gen Ye*/
                //delta_scf += alpha * (-3.0 * H * (1.0 + pvecback[pba->index_bg_p_scf] /pvecback[pba->index_bg_rho_scf]));
                delta_scf -= alpha * H * pvecback[pba->index_bg_phi_prime_scf] *
                             pvecback[pba->index_bg_phi_prime_scf] / a / pvecback[pba->index_bg_rho_scf];
                /*end of modification by Gen Ye*/
                theta_scf += k * k * alpha;
            }
        ...
        else
        {
            ppt->scalar_perturbations_data[ppw->index_ikout] =
                realloc(ppt->scalar_perturbations_data[ppw->index_ikout],
                        sizeof(double) * (ppt->size_scalar_perturbation_data[ppw->index_ikout] +
                                          ppt->number_of_scalar_titles));
        }
        storeidx = 0;
        ...
        /* perturbed recombination */
        class_store_double(dataptr, delta_temp, ppt->has_perturbed_recombination,
                           storeidx);
        class_store_double(dataptr, delta_chi, ppt->has_perturbed_recombination,
                           storeidx);
                                         ...
                                         || (ppt->has_source_delta_m == _TRUE_)))
        {
            for(n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++)
            {
                ...
                class_store_double(dataptr, delta_p_over_delta_rho_ncdm[n_ncdm],  _TRUE_,
                                   storeidx);
            }
        }
        /* Decaying cold dark matter */
        ...
        if(pba->has_ndescf == _TRUE_)
        {
            for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
            {
                class_store_double(dataptr, delta_ndescf[n_ndescf], _TRUE_, storeidx);
                class_store_double(dataptr, bigtheta_ndescf[n_ndescf], _TRUE_, storeidx);
                class_store_double(dataptr, cs2_eff_ndescf[n_ndescf], _TRUE_, storeidx);
                class_store_double(dataptr, delta_phi_ndescf[n_ndescf], _TRUE_, storeidx);
                class_store_double(dataptr, delta_phi_prime_ndescf[n_ndescf], _TRUE_, storeidx);
            }
        }
        /* Scalar field scf*/
        ...
        if(ppw->approx[ppw->index_ap_rsa] == (int)rsa_off)
        {
            ...
            else
            {
                delta_g = -4. / 3.*ppw->pv->y[ppw->pv->index_pt_gwdot] /
                          pvecthermo[pth->index_th_dkappa]; //TBC
                shear_g = 0.;
                l4_g = 0.;
        ...
        else
        {
            ppt->tensor_perturbations_data[ppw->index_ikout] =
                realloc(ppt->tensor_perturbations_data[ppw->index_ikout],
                        sizeof(double) * (ppt->size_tensor_perturbation_data[ppw->index_ikout] +
                                          ppt->number_of_tensor_titles));
        }
        storeidx = 0;
    ...
    /* free arrays used in ndescf by Gen Ye */
    if(pba->has_ndescf == _TRUE_)
    {
        free(delta_ndescf);
        free(bigtheta_ndescf);
        free(cs2_ad_ndescf);
        free(cs2_eff_ndescf);
        free(delta_phi_ndescf);
        free(delta_phi_prime_ndescf);
    }
                        ...
                        )
{
    ...
    double metric_continuity = 0., metric_euler = 0., metric_shear = 0.,
           metric_ufa_class = 0.;
    ...
    double rho_ncdm_bg, p_ncdm_bg, pseudo_p_ncdm, w_ncdm, ca2_ncdm, ceff2_ncdm = 0.,
                                                                    cvis2_ncdm = 0.;

    /* for use with non dark energy scalar fields: by Gen Ye*/
    int n_ndescf, idx_ndescf;
    double cs2_ndescf, ma, delta_ndescf, bigtheta_ndescf;
    ...
    if((pba->has_idm_dr == _TRUE_))
    {
        Sinv = 4. / 3. * pvecback[pba->index_bg_rho_idr] /
               pvecback[pba->index_bg_rho_idm_dr];
        dmu_idm_dr = pvecthermo[pth->index_th_dmu_idm_dr];
        dmu_idr = pth->b_idr / pth->a_idm_dr * pba->Omega0_idr / pba->Omega0_idm_dr *
                  dmu_idm_dr;
    }
    ...
    if(_scalars_)
    {
                ...
                && (ppw->approx[ppw->index_ap_tca] == (int)tca_off))
        {
            ...
            delta_temp = y[ppw->pv->index_pt_perturbed_recombination_delta_temp];
            delta_p_b_over_rho_b = pvecthermo[pth->index_th_wb] * (delta_b +
            ...
            alpha_rec = 1.14 * 4.309e-19 * pow((Tb_in_K * 1e-4),
                                               -0.6166) / (1 + 0.6703 * pow((Tb_in_K * 1e-4),
                                                       0.53)) ;

            // delta alpha, dimensionless
            delta_alpha_rec = (-0.6166 + 0.6703 * pow((Tb_in_K * 1e-4),
                               0.53) * (-0.6166 - 0.53)) / (1 + 0.6703 * pow((Tb_in_K * 1e-4),
                                       0.53)) * delta_temp;
        ...
        else
        {
            ...
            dy[pv->index_pt_theta_b] =
                (-a_prime_over_a * theta_b
                 + k2 * (delta_p_b_over_rho_b + R * (delta_g / 4. - s2_squared *
                         ppw->tca_shear_g))
                 + R * ppw->tca_slip) / (1. + R)
                + metric_euler;
        ...
        if(ppw->approx[ppw->index_ap_rsa] == (int)rsa_off)
        {
            ...
            if(ppw->approx[ppw->index_ap_tca] == (int)tca_off)
            {
                ...
                P0 = (y[pv->index_pt_pol0_g] + y[pv->index_pt_pol2_g] + 2.*s_l[2] *
                      y[pv->index_pt_shear_g]) / 8.;
                ...
                dy[pv->index_pt_shear_g] =
                    0.5 * (8. / 15.*(theta_g + metric_shear)
                           ...
                           - pvecthermo[pth->index_th_dkappa] * (2.*y[pv->index_pt_shear_g] - 4. / 5. /
                                   s_l[2] * P0));
                ...
                dy[pv->index_pt_l3_g] = k / (2.0 * l + 1.0) *
                                        (l * s_l[l] * 2.*s_l[2] * y[pv->index_pt_shear_g] - (l + 1.) * s_l[l + 1] *
                                         y[pv->index_pt_l3_g +
                                                             1])
                ...
                for(l = 4; l < pv->l_max_g; l++)
                {
                    ...
                    dy[pv->index_pt_delta_g + l] = k / (2.0 * l + 1.0) *
                                                   (l * s_l[l] * y[pv->index_pt_delta_g + l - 1] - (l + 1) * s_l[l + 1] *
                                                    y[pv->index_pt_delta_g + l +
                                                                           1])
                ...
                dy[pv->index_pt_delta_g + l] =
                    k * (s_l[l] * y[pv->index_pt_delta_g + l - 1] - (1. + l) * cotKgen *
                         y[pv->index_pt_delta_g + l])
                    - pvecthermo[pth->index_th_dkappa] * y[pv->index_pt_delta_g + l];
                ...
                dy[pv->index_pt_pol2_g] =
                    k / 5.*(2.*s_l[2] * y[pv->index_pt_pol2_g - 1] - 3.*s_l[3] *
                            y[pv->index_pt_pol2_g + 1])
                ...
                for(l = 3; l < pv->l_max_pol_g; l++)
                    dy[pv->index_pt_pol0_g + l] = k / (2.*l + 1) *
                                                  (l * s_l[l] * y[pv->index_pt_pol0_g + l - 1] - (l + 1.) * s_l[l + 1] *
                                                   y[pv->index_pt_pol0_g + l +
                                                                         1])
                ...
                dy[pv->index_pt_pol0_g + l] =
                    k * (s_l[l] * y[pv->index_pt_pol0_g + l - 1] - (l + 1) * cotKgen *
                         y[pv->index_pt_pol0_g + l])
                    - pvecthermo[pth->index_th_dkappa] * y[pv->index_pt_pol0_g + l];
            ...
            else
            {
                ...
                /* perturbed recombination has an impact **/
                dy[pv->index_pt_theta_g] =
                    -(dy[pv->index_pt_theta_b] + a_prime_over_a * theta_b - k2 *
                      delta_p_b_over_rho_b) / R
        ...
        if(pba->has_idm_dr == _TRUE_)
        {
            ...
            dy[pv->index_pt_delta_idm_dr] = -(y[pv->index_pt_theta_idm_dr] +
                                              metric_continuity); /* idm_dr density */

            if(ppw->approx[ppw->index_ap_tca_idm_dr] == (int)tca_idm_dr_off)
            {

                dy[pv->index_pt_theta_idm_dr] = - a_prime_over_a * y[pv->index_pt_theta_idm_dr]
                                                +
                                                metric_euler; /* idm_dr velocity */
                dy[pv->index_pt_theta_idm_dr] -= (Sinv * dmu_idm_dr *
                                                  (y[pv->index_pt_theta_idm_dr] - theta_idr) -
                                                  k2 * pvecthermo[pth->index_th_cidm_dr2] * y[pv->index_pt_delta_idm_dr]);
            }
            else
            {

                tca_slip_idm_dr = (pth->nindex_idm_dr - 2. / (1. + Sinv)) * a_prime_over_a *
                                  (y[pv->index_pt_theta_idm_dr] - theta_idr) + 1. / (1. + Sinv) / dmu_idm_dr *
                                  (-(pvecback[pba->index_bg_H_prime] * a + 2. * a_prime_over_a * a_prime_over_a) *
                                   y[pv->index_pt_theta_idm_dr] - a_prime_over_a *
                                   (.5 * k2 * delta_idr + metric_euler) + k2 * (pvecthermo[pth->index_th_cidm_dr2]
                                           *
                                           dy[pv->index_pt_delta_idm_dr] - 1. / 4.*dy[pv->index_pt_delta_idr]));

                ppw->tca_shear_idm_dr = 0.5 * 8. / 15. / dmu_idm_dr / ppt->alpha_idm_dr[0] *
                                        (y[pv->index_pt_theta_idm_dr] + metric_shear);

                dy[pv->index_pt_theta_idm_dr] = 1. / (1. + Sinv) * (- a_prime_over_a *
                                                y[pv->index_pt_theta_idm_dr]
                                                + k2 * pvecthermo[pth->index_th_cidm_dr2] *
                                                y[pv->index_pt_delta_idm_dr] + k2 * Sinv * (delta_idr / 4. -
                                                        ppw->tca_shear_idm_dr)) + metric_euler
                                                + Sinv / (1. + Sinv) * tca_slip_idm_dr;
            }
        }
                ...
                && (ppw->approx[ppw->index_ap_tca] == (int)tca_off))
        {
            ...
            dy[ppw->pv->index_pt_perturbed_recombination_delta_chi] = - alpha_rec * a * chi
                    * n_H  *
                    (delta_alpha_rec + delta_chi + delta_b) * _Mpc_over_m_ / _c_ ;

            /* see the documentation for this formula */
            dy[ppw->pv->index_pt_perturbed_recombination_delta_temp] =  2. / 3. *
                    dy[ppw->pv->index_pt_delta_b]
                    - a * Compton_CR
                    * pow(pba->T_cmb / a, 4) * chi / (1. + chi + fHe) * ((1. - pba->T_cmb / a /
                            pvecthermo[pth->index_th_Tb]) * (delta_g + delta_chi * (1. + fHe) /
                                    (1. + chi + fHe))
                            + pba->T_cmb / a / pvecthermo[pth->index_th_Tb] * (delta_temp - 1. / 4. *
                                    delta_g));
        ...
        if(pba->has_dcdm == _TRUE_)
        {
            ...
            dy[pv->index_pt_theta_dcdm] = - a_prime_over_a * y[pv->index_pt_theta_dcdm] +
                                          metric_euler; /* dcdm velocity */
        }
        ...
        if((pba->has_dcdm == _TRUE_) && (pba->has_dr == _TRUE_))
        {
            ...
            */
            ...
            fprime_dr = pba->Gamma_dcdm * pvecback[pba->index_bg_rho_dcdm] * pow(a,
                        5) / pow(pba->H0, 2);

            /** - ----> dr F0 */
            dy[pv->index_pt_F0_dr] = -k * y[pv->index_pt_F0_dr + 1] - 4. /
                                     3.*metric_continuity * f_dr +
                                     fprime_dr * (y[pv->index_pt_delta_dcdm] + metric_euler / k2);

            /** - ----> dr F1 */
            dy[pv->index_pt_F0_dr + 1] = k / 3.*y[pv->index_pt_F0_dr] - 2. / 3.*k *
                                         y[pv->index_pt_F0_dr + 2] *
                                         s2_squared +
                                         4 * metric_euler / (3.*k) * f_dr + fprime_dr / k * y[pv->index_pt_theta_dcdm];

            /** - ----> exact dr F2 */
            dy[pv->index_pt_F0_dr + 2] = 8. / 15.*(3. / 4.*k * y[pv->index_pt_F0_dr + 1] +
                                                   metric_shear * f_dr)
                                         - 3. / 5.*k * s_l[3] / s_l[2] * y[pv->index_pt_F0_dr + 3];

            /** - ----> exact dr l=3 */
            l = 3;
            dy[pv->index_pt_F0_dr + 3] = k / (2.*l + 1.) *
                                         (l * s_l[l] * s_l[2] * y[pv->index_pt_F0_dr + 2] - (l + 1.) * s_l[l + 1] *
                                          y[pv->index_pt_F0_dr +
                                                               4]);
            ...
            for(l = 4; l < pv->l_max_dr; l++)
            {
                dy[pv->index_pt_F0_dr + l] = k / (2.*l + 1) *
                                             (l * s_l[l] * y[pv->index_pt_F0_dr + l - 1] - (l + 1.) * s_l[l + 1] *
                                              y[pv->index_pt_F0_dr + l +
                                                                   1]);
            }
            ...
            dy[pv->index_pt_F0_dr + l] =
                k * (s_l[l] * y[pv->index_pt_F0_dr + l - 1] - (1. + l) * cotKgen *
                     y[pv->index_pt_F0_dr + l]);
        ...
        if(pba->has_fld == _TRUE_)
        {
            ...
            {
                dy[pv->index_pt_Gamma_fld] =
                    ppw->Gamma_prime_fld; /* Gamma variable of PPF formalism */
            }
        ...
        if(pba->has_ndescf == _TRUE_)
        {
            for(n_ndescf = 0; n_ndescf < pba->N_ndescf; n_ndescf++)
            {
                /* fluid approx, x1=delta x2=bigtheta=(1+w)theta */
                if(ppw->approx[ppw->index_ap_fa_ndescf1 + n_ndescf] == (int)fa_ndescf_on)
                {

                    /* rest frame sound speed is potential dependent, currently only support axion */
                    if(pba->ndescf_parameters[pba->ndescf_parameters_size * (n_ndescf + 1) - 3] < 0)
                    {
                        ma = pba->ndescf_parameters[pba->ndescf_parameters_size * n_ndescf + 1];
                        cs2 = k2 / (4 * ma * ma * a2) / (1 + k2 / (4 * ma * ma * a2));
                    }

                    w_fld = pba->ndescf_w_fld[n_ndescf];
                    ca2 = w_fld;
                    /* actual dynamic variables in fld approx */
                    dy[pv->index_pt_x1_ndescf1 + n_ndescf] = -y[pv->index_pt_x2_ndescf1 + n_ndescf]
                            -
                            (1 + w_fld) * metric_continuity - 3.*(cs2 - w_fld) * a_prime_over_a *
                            y[pv->index_pt_x1_ndescf1 +
                                                      n_ndescf] - 9. * (cs2 - ca2) * a_prime_over_a * a_prime_over_a *
                            y[pv->index_pt_x2_ndescf1 +
                                                      n_ndescf] / k2;
                    dy[pv->index_pt_x2_ndescf1 + n_ndescf] = -(1. - 3.*cs2) * a_prime_over_a *
                            y[pv->index_pt_x2_ndescf1 + n_ndescf] + cs2 * k2 * y[pv->index_pt_x1_ndescf1 +
                                    n_ndescf] +
                            (1. + w_fld) * metric_euler;

                }
                /* KG equation, x1=delta_phi x2=delta_phi_prime */
                else
                {
                    dy[pv->index_pt_x1_ndescf1 + n_ndescf] = y[pv->index_pt_x2_ndescf1 + n_ndescf];
                    dy[pv->index_pt_x2_ndescf1 + n_ndescf] =  - 2.*a_prime_over_a *
                            y[pv->index_pt_x2_ndescf1 + n_ndescf]
                            - metric_continuity * pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf]
                            - (k2 + a2 * pvecback[pba->index_bg_ddV_ndescf1 + n_ndescf]) *
                            y[pv->index_pt_x1_ndescf1 +
                                                      n_ndescf];
                    /* We determine the fluid initial condition by averaging over the
                     * peak and trough of the last oscillation */
                    if(tau > pba->ndescf_tau_avgfld[n_ndescf])
                    {
//                        delta_ndescf = 1. / 3.*(1. / a2 * pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf] *
//                                                y[pv->index_pt_x2_ndescf1 + n_ndescf] + pvecback[pba->index_bg_dV_ndescf1 + n_ndescf] *
//                                                y[pv->index_pt_x1_ndescf1 + n_ndescf]) / pvecback[pba->index_bg_rho_ndescf1 + n_ndescf];
                        bigtheta_ndescf = 1. / 3. * k2 / a2 * pvecback[pba->index_bg_phi_prime_ndescf1 + n_ndescf] *
                                          y[pv->index_pt_x1_ndescf1 + n_ndescf] / pvecback[pba->index_bg_rho_ndescf1 + n_ndescf];
                        idx_ndescf = pppaw->index_k * pba->N_ndescf + n_ndescf;
//                        if(fabs(k-0.1)<0.001)
//                            printf("%g, min=%g,max=%g\n",
//                                   bigtheta_ndescf,
//                                   ppw->ndescf_bigtheta_min[idx_ndescf],
//                                   ppw->ndescf_bigtheta_max[idx_ndescf]);
//                        ppw->ndescf_delta_max[idx_ndescf] = MAX(delta_ndescf, ppw->ndescf_delta_max[idx_ndescf]);
//                        ppw->ndescf_delta_min[idx_ndescf] = MIN(delta_ndescf, ppw->ndescf_delta_min[idx_ndescf]);
                        ppw->ndescf_bigtheta_max[idx_ndescf] = MAX(bigtheta_ndescf, ppw->ndescf_bigtheta_max[idx_ndescf]);
                        ppw->ndescf_bigtheta_min[idx_ndescf] = MIN(bigtheta_ndescf, ppw->ndescf_bigtheta_min[idx_ndescf]);
                    }
                }
            }
        }
        ...
        if(pba->has_scf == _TRUE_)
        {
            ...
            dy[pv->index_pt_phi_prime_scf] =  - 2.*a_prime_over_a *
                                              y[pv->index_pt_phi_prime_scf]
                                              - metric_continuity *
                                              pvecback[pba->index_bg_phi_prime_scf] //  metric_continuity = h'/2
                                              - (k2 + a2 * pvecback[pba->index_bg_ddV_scf]) *
                                              y[pv->index_pt_phi_scf]; //checked
        ...
        if(pba->has_idr == _TRUE_)
        {
            ...
            if(ppw->approx[ppw->index_ap_rsa_idr] == (int)rsa_idr_off)
            {
                                                    ...
                                                    && (ppw->approx[ppw->index_ap_tca_idm_dr] == (int)tca_idm_dr_off)))
                {
                    ...
                    /** - ----> idr velocity */
                    if(ppt->idr_nature == idr_free_streaming)
                        dy[pv->index_pt_theta_idr] = k2 * (y[pv->index_pt_delta_idr] / 4. - s2_squared *
                                                           y[pv->index_pt_shear_idr]) + metric_euler;
                    else
                        dy[pv->index_pt_theta_idr] = k2 / 4. * y[pv->index_pt_delta_idr] + metric_euler;

                    if(pba->has_idm_dr == _TRUE_)
                        dy[pv->index_pt_theta_idr] += dmu_idm_dr * (y[pv->index_pt_theta_idm_dr] -
                    ...
                    if(ppt->idr_nature == idr_free_streaming)
                    {
                        ...
                        /** - ----> exact idr shear */
                        l = 2;
                        dy[pv->index_pt_shear_idr] = 0.5 * (8. / 15.*(y[pv->index_pt_theta_idr] +
                                                            metric_shear) - 3. / 5.*k
                                                            * s_l[3] / s_l[2] * y[pv->index_pt_shear_idr + 1]);
                        if(pba->has_idm_dr == _TRUE_)
                            dy[pv->index_pt_shear_idr] -= (ppt->alpha_idm_dr[l - 2] * dmu_idm_dr +
                                                           ppt->beta_idr[l - 2] *
                                                           dmu_idr) * y[pv->index_pt_shear_idr];

                        /** - ----> exact idr l=3 */
                        l = 3;
                        dy[pv->index_pt_l3_idr] = k / (2.*l + 1.) * (l * 2.*s_l[l] * s_l[2] *
                                                  y[pv->index_pt_shear_idr] -
                                                  (l + 1.) * s_l[l + 1] * y[pv->index_pt_l3_idr + 1]);
                        if(pba->has_idm_dr == _TRUE_)
                            dy[pv->index_pt_l3_idr] -= (ppt->alpha_idm_dr[l - 2] * dmu_idm_dr +
                                                        ppt->beta_idr[l - 2] * dmu_idr)
                                                       * y[pv->index_pt_l3_idr];

                        /** - ----> exact idr l>3 */
                        for(l = 4; l < pv->l_max_idr; l++)
                        {
                            dy[pv->index_pt_delta_idr + l] = k / (2.*l + 1) * (l * s_l[l] *
                            ...
                            if(pba->has_idm_dr == _TRUE_)
                                dy[pv->index_pt_delta_idr + l] -= (ppt->alpha_idm_dr[l - 2] * dmu_idm_dr +
                                                                   ppt->beta_idr[l - 2] *
                                                                   dmu_idr) * y[pv->index_pt_delta_idr + l];
                        }
                ...
                {
                    dy[pv->index_pt_theta_idr] = 1. / (1. + Sinv) * (- a_prime_over_a *
                                                 y[pv->index_pt_theta_idm_dr] +
                                                 k2 * pvecthermo[pth->index_th_cidm_dr2] * y[pv->index_pt_delta_idm_dr]
                                                 + k2 * Sinv * (1. / 4.*y[pv->index_pt_delta_idr] - ppw->tca_shear_idm_dr)) +
                                                 metric_euler - 1. /
                                                 (1. + Sinv) * tca_slip_idm_dr;
        ...
        if(pba->has_ur == _TRUE_)
        {
            ...
            if(ppw->approx[ppw->index_ap_rsa] == (int)rsa_off)
            {
                ...
                dy[pv->index_pt_delta_ur] =
                    ...
                    + (1. - ppt->three_ceff2_ur) * a_prime_over_a * (y[pv->index_pt_delta_ur] +
                            4.*a_prime_over_a *
                            y[pv->index_pt_theta_ur] / k / k);

                /** - -----> ur velocity */
                dy[pv->index_pt_theta_ur] =
                    // standard term with extra coefficient (3 ceff2_ur), normally equal to one
                    k2 * (ppt->three_ceff2_ur * y[pv->index_pt_delta_ur] / 4. - s2_squared *
                          y[pv->index_pt_shear_ur]) +
                    metric_euler
                ...
                if(ppw->approx[ppw->index_ap_ufa] == (int)ufa_off)
                {
                    ...
                    dy[pv->index_pt_shear_ur] =
                        0.5 * (
                            // standard term
                            8. / 15.*(y[pv->index_pt_theta_ur] + metric_shear) - 3. / 5.*k * s_l[3] / s_l[2]
                            *
                            y[pv->index_pt_shear_ur + 1]
                            // non-standard term, non-zero if cvis2_ur not 1/3
                            - (1. - ppt->three_cvis2_ur) * (8. / 15.*(y[pv->index_pt_theta_ur] +
                                                            metric_shear)));

                    /** - -----> exact ur l=3 */
                    l = 3;
                    dy[pv->index_pt_l3_ur] = k / (2.*l + 1.) *
                                             (l * 2.*s_l[l] * s_l[2] * y[pv->index_pt_shear_ur] - (l + 1.) * s_l[l + 1] *
                                              y[pv->index_pt_l3_ur +
                                                                   1]);
                    ...
                    for(l = 4; l < pv->l_max_ur; l++)
                    {
                        dy[pv->index_pt_delta_ur + l] = k / (2.*l + 1) *
                                                        (l * s_l[l] * y[pv->index_pt_delta_ur + l - 1] - (l + 1.) * s_l[l + 1] *
                    ...
                    dy[pv->index_pt_delta_ur + l] =
                        k * (s_l[l] * y[pv->index_pt_delta_ur + l - 1] - (1. + l) * cotKgen *
                             y[pv->index_pt_delta_ur + l]);
        ...
        if(pba->has_ncdm == _TRUE_)
        {
            ...
            if(ppw->approx[ppw->index_ap_ncdmfa] == (int)ncdmfa_on)
            {
                ...
                for(n_ncdm = 0; n_ncdm < pv->N_ncdm; n_ncdm++)
                {
                    ...
                    rho_ncdm_bg = pvecback[pba->index_bg_rho_ncdm1 +
                                                                   n_ncdm]; /* background density */
                    p_ncdm_bg = pvecback[pba->index_bg_p_ncdm1 + n_ncdm]; /* background pressure */
                    pseudo_p_ncdm = pvecback[pba->index_bg_pseudo_p_ncdm1 +
                                                                          n_ncdm]; /* pseudo-pressure (see CLASS IV paper) */
                    w_ncdm = p_ncdm_bg / rho_ncdm_bg; /* equation of state parameter */
                    ca2_ncdm = w_ncdm / 3.0 / (1.0 + w_ncdm) * (5.0 - pseudo_p_ncdm /
                               p_ncdm_bg); /* adiabatic sound speed */
                    ...
                    if(ppr->ncdm_fluid_approximation == ncdmfa_mb)
                    {
                        ...
                        dy[idx + 2] = -3.0 * (a_prime_over_a * (2. / 3. - ca2_ncdm - pseudo_p_ncdm /
                                                                p_ncdm_bg / 3.) + 1. /
                                              tau) * y[idx + 2]
                                      + 8.0 / 3.0 * cvis2_ncdm / (1.0 + w_ncdm) * s_l[2] * (y[idx + 1] +
                                              metric_shear);
            ...
            else
            {
                ...
                for(n_ncdm = 0; n_ncdm < pv->N_ncdm; n_ncdm++)
                {
                    ...
                    for(index_q = 0; index_q < pv->q_size_ncdm[n_ncdm]; index_q++)
                    {
                        ...
                        dy[idx + 2] = qk_div_epsilon / 5.0 * (2 * s_l[2] * y[idx + 1] - 3.*s_l[3] *
                                                              y[idx + 3])
                        ...
                        {
                            dy[idx + l] = qk_div_epsilon / (2.*l + 1.0) * (l * s_l[l] * y[idx + (l - 1)] -
                        ...
                        dy[idx + l] = qk_div_epsilon * y[idx + l - 1] - (1. + l) * k * cotKgen * y[idx +
                                      l];
    ...
    if(_vectors_)
    {
        ...
        if(ppt->gauge == synchronous)
        {
            ...
            dy[pv->index_pt_theta_b] = -(1 - 3.*cb2) * a_prime_over_a *
                                       y[pv->index_pt_theta_b]
                                       - pvecthermo[pth->index_th_dkappa] * (_SQRT2_ / 4.*delta_g +
                                               y[pv->index_pt_theta_b]);
        ...
        else if(ppt->gauge == newtonian)
        {
            ...
            dy[pv->index_pt_theta_b] = -(1 - 3.*cb2) * a_prime_over_a *
                                       y[pv->index_pt_theta_b]
                                       - _SQRT2_ / 4.*pvecthermo[pth->index_th_dkappa] * (delta_g + 2.*_SQRT2_ *
                                               y[pv->index_pt_theta_b])
                                       + pvecmetric[ppw->index_mt_V_prime] + (1. - 3.*cb2) * a_prime_over_a *
                                       y[pv->index_pt_V];
        ...
        */
        ...
        if(ppt->gauge == synchronous)
        {
            ...
            dy[pv->index_pt_delta_g] =
                -4. / 3.*theta_g
                - pvecthermo[pth->index_th_dkappa] * (delta_g + 2.*_SQRT2_ *
                        y[pv->index_pt_theta_b]);
    ...
    if(_tensors_)
    {
        ...
        if(ppt->evolve_tensor_ur == _TRUE_)
        {
            ...
            dy[pv->index_pt_delta_ur] = -4. / 3.*y[pv->index_pt_theta_ur] + _SQRT6_ *
                                        y[pv->index_pt_gwdot];

            dy[pv->index_pt_theta_ur] = k2 * (y[pv->index_pt_delta_ur] / 4. - s2_squared *
                                              y[pv->index_pt_shear_ur]);
        ...
        if(ppt->evolve_tensor_ncdm == _TRUE_)
        {
            ...
            for(n_ncdm = 0; n_ncdm < pv->N_ncdm; n_ncdm++)
            {
                ...
                for(index_q = 0; index_q < pv->q_size_ncdm[n_ncdm]; index_q++)
                {
                    ...
                    dy[idx] = -qk_div_epsilon * y[idx + 1] - 0.25 * _SQRT6_ * y[pv->index_pt_gwdot]
                              * dlnf0_dlnq;
                                    ...
                                    )
{
    ...
    a = pvecback[pba->index_bg_a];
    a_prime_over_a = pvecback[pba->index_bg_H] * a;
    a_primeprime_over_a = pvecback[pba->index_bg_H_prime] * a + 2. * a_prime_over_a
                          * a_prime_over_a;
    R = 4. / 3. * pvecback[pba->index_bg_rho_g] / pvecback[pba->index_bg_rho_b];
    s2_squared = 1. - 3.*pba->K / k2;
    ...
    dtau_c = -pvecthermo[pth->index_th_ddkappa] * tau_c *
    ...
    {
        F_prime = dtau_c / (1 + R) + tau_c * a_prime_over_a * R / (1 + R) / (1 +
                  R); /*F' needed by second_order_CLASS and compromise_CLASS */
        if(ppr->tight_coupling_approximation == (int)second_order_CLASS)
        {
            F_prime_prime = (- pvecthermo[pth->index_th_dddkappa] * tau_c *
                             tau_c /* F'' needed by second_order_CLASS only */
                             + 2.*pvecthermo[pth->index_th_ddkappa] * pvecthermo[pth->index_th_ddkappa] *
                             tau_c * tau_c *
                             tau_c) / (1 + R)
                            + 2.*dtau_c * a_prime_over_a * R / (1 + R) / (1 + R)
                            + tau_c * ((a_primeprime_over_a - 2.*a_prime_over_a * a_prime_over_a) +
                                       2.*a_prime_over_a *
                                       a_prime_over_a * R / (1 + R)) * R / (1 + R) / (1 + R);
        }
    }
    ...
    theta_prime = (-a_prime_over_a * theta_b + k2 * (cb2 * delta_b + R /
                   4.*delta_g)) /
                  (1. + R) + metric_euler;

    /** - ---> intermediate quantities for 2nd order tca: shear_g_prime at first order in tight-coupling */
    shear_g_prime = 16. / 45.*(tau_c * (theta_prime + metric_shear_prime) + dtau_c *
                               (theta_g + metric_shear));
    ...
    if(ppr->tight_coupling_approximation == (int)second_order_CRS)
    {
        ...
        if(ppt->gauge == synchronous)
        {
            ...
            slip = (-2. / (1. + R) * a_prime_over_a - pvecthermo[pth->index_th_ddkappa] /
                    pvecthermo[pth->index_th_dkappa]) * (theta_b - theta_g)
                   ...
                   - 2.*R * (3.*a_prime_over_a * a_prime_over_a * cb2 + (1. + R) *
                             (a_primeprime_over_a -
                              a_prime_over_a * a_prime_over_a) - 3.*a_prime_over_a * a_prime_over_a)
                   ...
                   + (
                       ...
                       + k2 * (1. - 3.*cb2) * Delta / 6.
                   ) / pvecthermo[pth->index_th_dkappa] / pvecthermo[pth->index_th_dkappa] /
                   (1. + R) / (1. + R)
                   - (4.*a_primeprime_over_a * theta_b - 4.*k2 * cb2 * (-theta_b -
                           metric_continuity) +
                      2.*a_prime_over_a * k2 * delta_g + k2 * 4. / 3.*(-theta_g -
                              metric_continuity)) / 2. / (1. + R) /
                   (1. + R) * pvecthermo[pth->index_th_ddkappa] /
                   pvecthermo[pth->index_th_dkappa] /
                   pvecthermo[pth->index_th_dkappa] / pvecthermo[pth->index_th_dkappa]
            ...
            shear_g = (1. - 11. / 6.*dtau_c) * shear_g - 11. / 6.*tau_c * 16. / 45.*tau_c *
    ...
    if(ppr->tight_coupling_approximation == (int)second_order_CLASS)
    {
        ...
        if(ppt->gauge == synchronous)
        {
            ...
            theta_prime_prime = ((R - 1.) * a_prime_over_a * theta_prime -
                                 (a_primeprime_over_a - a_prime_over_a
                                  * a_prime_over_a) * theta_b
                                 + k2 * (pvecthermo[pth->index_th_dcb2] * delta_b + cb2 *
                                         (-theta_b - metric_continuity) -
                                         a_prime_over_a * R / 4.*delta_g + R / 4.*4. / 3.*(-theta_g -
                                                 metric_continuity))) / (1. + R);

            /* zero-order quantities g0, g0', go'' */
            g0 = -a_prime_over_a * theta_b + k2 * (cb2 * delta_b - delta_g / 4.);
            g0_prime = -a_prime_over_a * theta_prime - (a_primeprime_over_a - a_prime_over_a
                       * a_prime_over_a) *
                       theta_b + k2 * (pvecthermo[pth->index_th_dcb2] * delta_b + (1. / 3. - cb2) *
                                       (theta_b + 0.5 * pvecmetric[ppw->index_mt_h_prime]));
            g0_prime_prime = -a_prime_over_a * theta_prime_prime - 2.*
                             (a_primeprime_over_a - a_prime_over_a *
                              a_prime_over_a) * theta_prime
                             - (2.*a_prime_over_a * a_prime_over_a * a_prime_over_a - 3.*a_primeprime_over_a
                                * a_prime_over_a) *
                             theta_b
                             + k2 * (pvecthermo[pth->index_th_ddcb2] * delta_b -
                                     2.*pvecthermo[pth->index_th_dcb2] *
                                     (theta_b + 0.5 * pvecmetric[ppw->index_mt_h_prime]) + (1. / 3. - cb2) *
                                     (theta_prime + 0.5 * pvecmetric[ppw->index_mt_h_prime_prime]));

            /* slip at second order */
            slip = (1. - 2 * a_prime_over_a * F) * slip + F * k2 * s2_squared *
                   (2.*a_prime_over_a * shear_g +
                    shear_g_prime)
                   - F * (F_prime_prime * g0 + 2.*F_prime * g0_prime + F * g0_prime_prime);

            /* second-order correction to shear */
            shear_g = (1. - 11. / 6.*dtau_c) * shear_g - 11. / 6.*tau_c * 16. / 45.*tau_c *
                      (theta_prime + metric_shear_prime);
    ...
    if(ppr->tight_coupling_approximation == (int)compromise_CLASS)
    {
        ...
        slip = (1. - 2.*a_prime_over_a * F) * slip + F * k2 * (2.*a_prime_over_a *
                s2_squared * shear_g +
                s2_squared * shear_g_prime - (1. / 3. - cb2) * (F * theta_prime + 2.*F_prime *
                        theta_b));
...
)
{
    ...
    if(ppt->gauge == synchronous)
    {
        ...
        else
        {
            ...
            ppw->rsa_delta_g = 4. / k2 * (a_prime_over_a *
                                          ppw->pvecmetric[ppw->index_mt_h_prime]
        ...
        if(pba->has_ur == _TRUE_)
        {
            ...
            {
                ppw->rsa_delta_ur = 4. / k2 * (a_prime_over_a *
                                               ppw->pvecmetric[ppw->index_mt_h_prime]
                                               - k2 * y[ppw->pv->index_pt_eta]);
    ...
    ppw->rho_plus_p_theta += 4. / 3.*ppw->pvecback[pba->index_bg_rho_g] *
                             ppw->rsa_theta_g;
    ...
    if(pba->has_ur == _TRUE_)
    {
        ...
        ppw->rho_plus_p_theta += 4. / 3.*ppw->pvecback[pba->index_bg_rho_ur] *
                                 ppw->rsa_theta_ur;
    }
...
)
{
    ...
    if(ppt->gauge == synchronous)
    {
        ...
        if(ppw->approx[ppw->index_ap_rsa_idr] == (int)rsa_idr_on)
        {
            ...
            ppw->rsa_delta_idr = 4. / k2 * (a_prime_over_a *
                                            ppw->pvecmetric[ppw->index_mt_h_prime]
                                            - k2 * y[ppw->pv->index_pt_eta]);
